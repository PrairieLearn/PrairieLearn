...
function getParamsForQuestion(q) {
    ...
    return {
        ...
        manual_grading_autograde_score_weight: (q.manualGradingOptions && q.manualGradingOptions.autograde_score_weight),
        manual_grading_manual_score_weight: (q.manualGradingOptions && q.manualGradingOptions.manual_score_weight),
