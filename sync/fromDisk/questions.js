...
function getParamsForQuestion(q) {
    ...
    return {
        ...
        manual_grading_autograde_score_weight: (q.manualGradingEnabled && q.manualGradingOptions && q.manualGradingOptions.autograde_weight),
        manual_grading_manual_score_weight: (q.manualGradingEnabled && q.manualGradingOptions && q.manualGradingOptions.manual_score_weight),
