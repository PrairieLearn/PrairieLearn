...
BEGIN
    ...
    SET
        ...
        manual_grading_autograde_score_weight = (src.data->>'manual_grading_score')::integer,
        manual_grading_manual_score_weight = (src.data->>'manual_grading_manual_score_weight')::integer,
