DROP FUNCTION IF EXISTS get_quintile_stats_using_saved_assessments_using_cutoff_algorithm(BIGINT);
CREATE FUNCTION get_quintile_stats_using_saved_assessments_using_cutoff_algorithm(
