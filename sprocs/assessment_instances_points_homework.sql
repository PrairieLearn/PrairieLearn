DROP FUNCTION IF EXISTS assessment_points_homework(bigint,integer);

CREATE OR REPLACE FUNCTION
    assessment_instances_points_homework(
...
BEGIN
    ...
    WHERE
        iq.assessment_instance_id = assessment_instances_points_homework.assessment_instance_id
