...
module.exports.questionPath = function(questionDirectory, coursePath, callback) {
    var fullPath = path.join(coursePath, "questions", questionDirectory);
    callback(null, fullPath);
};

module.exports.questionFilePathNEW = function(filename, questionDirectory, coursePath, callback) {
    var fullPath = path.join(coursePath, "questions", questionDirectory, filename);
    callback(null, fullPath);
};
