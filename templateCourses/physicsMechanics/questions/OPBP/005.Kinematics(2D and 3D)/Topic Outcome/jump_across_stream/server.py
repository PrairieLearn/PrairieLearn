...
def generate(data):
    ...
    if (y_travelled >= y_needed):
        data2["params"]["part5"]["ans1"]["value"] = "Yes, the bear makes it to the other side of the stream."
        data2["params"]["part5"]["ans1"]["correct"] = True
    
        data2["params"]["part5"]["ans2"]["value"] = "No, the bear does not make it to the other side of the stream."
    ...
    data2["correct_answers"]["part7_ans"] = v_j * time_highest - 0.5 * a * time_highest**2
    ...
    # define possible answers
    data2["params"]["part9"]["ans1"]["value"] = "The problem would become a 1-D problem with motion only in the $y$-direction."
    data2["params"]["part9"]["ans1"]["correct"] = True
    
    data2["params"]["part9"]["ans2"]["value"] = "The problem would become a 1-D problem with motion only in the $x$-direction."
