...
def generate(data):
    ...
    data2["params"]["part1"]["ans3"]["value"] = f"$F = $ {m*2.5} $N$ from 2 to 6 $s$, then $F = $ {m*-2.5} $N$ from 6 to 10 $s$"
    data2["params"]["part1"]["ans3"]["correct"] = False
    
    data2["params"]["part1"]["ans4"]["value"] = f"$F = $ {m*-2.5} $N$ from 2 to 6 $s$, then $F = $ {m*2.5} $N$ from 6 to 10 $s$"
