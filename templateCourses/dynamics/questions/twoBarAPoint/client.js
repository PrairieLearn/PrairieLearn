define(["sylvester", "text!./question.html", "text!./answer.html", "text!./submission.html", "SimpleClient", "SimpleFigure", "PrairieGeom"], function(Sylvester, questionTemplate, answerTemplate, submissionTemplate, SimpleClient, SimpleFigure, PrairieGeom) {
    ...
    var drawFcn = function() {
        ...
        this.pd.circleArrow(O, rAlpha, rOPAngle - dTheta, rOPAngle + dTheta, "angAcc", true);
        this.pd.circleArrow(rP, rAlpha, rPQAngle - dTheta, rPQAngle + dTheta, "angAcc", true);
        ...
        this.pd.labelCircleLine(O, rAlpha, rOPAngle - dTheta, rOPAngle + dTheta, $V([1, 0]), "TEX:$\\alpha_1$", true);
        this.pd.labelCircleLine(rP, rAlpha, rPQAngle - dTheta, rPQAngle + dTheta, $V([circleSide, 0]), "TEX:$\\alpha_2$", true);
