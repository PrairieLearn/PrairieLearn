...
def generate(data):
    ...
    data["params"]["sddotMag"] = sddotDir * sddotMag
    enhatComp = v**2 / rho
    data["params"]["enhatComp"] = float(math.ceil(enhatComp * 10000) / 10000)

    data["correct_answers"]["a_i"] = float(a[0])
    data["correct_answers"]["a_j"] = float(a[1])
