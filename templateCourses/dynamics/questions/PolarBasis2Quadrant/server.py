...
def generate(data):
    ...
    if theta == 30:
        expr = random.choice(
            [
                "\\hat{e}_r      =  \\frac{\\sqrt{3}}{2} \\hat\\imath + \\frac{1}{2}        \\hat\\jmath",
        ...
        expr = random.choice(
            [
                "\\hat{e}_r      =  \\frac{1}{\\sqrt{2}} \\hat\\imath + \\frac{1}{\\sqrt{2}} \\hat\\jmath",
        ...
        expr = random.choice(
            [
                "\\hat{e}_r      =  \\frac{1}{2} \\hat\\imath + \\frac{\\sqrt{3}}{2} \\hat\\jmath",
