...
def generate(data):
	...
	data['correct_answers']['ethati'] = float(et[0])
	data['correct_answers']['ethatj'] = float(et[1])
	data['correct_answers']['enhati'] = float(en[0])
	data['correct_answers']['enhatj'] = float(en[1])
