...
def generate(data):
    ...
    if ansChoice == "v0":
        ...
        ansVar = "v_{C,0}"
        ansDesc = (
            "speed $v_{C,0}$ of the hoop center at the initial position on the slope"
        )
        ansUnits = "m/s"
    elif ansChoice == "vf":
        vf = np.nan
    ...
    if ansChoice != "v0":
        descs.append(
            "speed of the hoop center at the initial position on the slope is $v_{C,0} = "
            + f"{v0}"
            + "\\rm\\ m/s$"
        )
    if ansChoice != "vf":
        descs.append(
            "speed of the hoop center at the bottom of the slope is $v_{C,\\rm f} = "
            + f"{vf}"
            + "\\rm\\ m/s$"
        )
    ...
    if ansChoice != "h":
        descs.append(
            "initial height of the hoop center on the slope is $h = "
            + f"{h}"
            + "\\rm\\ m$"
        )
