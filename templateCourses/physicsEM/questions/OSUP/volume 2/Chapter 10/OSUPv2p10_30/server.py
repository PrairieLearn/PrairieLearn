...
feedback_dict = {'vars': ['part1_ans', 'part2_ans', 'part3_ans', 'part4_ans', 'part5_ans', 'part6_ans', 'part7_ans', 'part8_ans'],
                 'stringData': ['I_\mathrm{1s}', 'P_\mathrm{1s}', 'I_\mathrm{2s}', 'P_\mathrm{2s}', 'I_\mathrm{1p}', 'P_\mathrm{1p}', 'I_\mathrm{2p}', 'P_\mathrm{2p}'],
                 'units': ['$\rm\ A$', '$\rm\ W$', '$\rm\ A$', '$\rm\ W$', '$\rm\ A$', '$\rm\ W$', '$\rm\ A$', '$\rm\ W$']
                 }
