...
rtol = 0.03
errorCheck = 'True'
feedback_dict = {'vars': ['part1_ans', 'part2_ans', 'part3_ans', 'part4_ans', 'part5_ans', 'part6_ans', 'part7_ans'],
                 'stringData': ['V_{R_1}', 'V_{R_2}', 'V_{R_3}', 'V_{R_4}', 'V_{R_5}', 'P_{~\\rm in}', 'P_{~\\rm out}'],
                 'units': ['$~\mathrm{V}$', '$~\mathrm{V}$', '$~\mathrm{V}$', '$~\mathrm{V}$', '$~\mathrm{V}$', '$~\mathrm{W}$', '$~\mathrm{W}$']
                 }
