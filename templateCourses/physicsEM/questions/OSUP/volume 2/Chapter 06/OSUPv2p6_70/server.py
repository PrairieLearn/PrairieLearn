...
stringData = ['\\sigma_\mathrm{inner}', '\\sigma_\mathrm{outer}', 'Q'] # For some reason a double backslash is needed.
units = ['$~\mathrm{N}/\mathrm{m}^2$', '$~\mathrm{N}/\mathrm{m}^2$', '$~\mathrm{C}$'] # Use LaTeX notation $~\mathrm{unit}$
def parse(data):
