...
ALTER INDEX chunks_unique_values_key RENAME TO chunks_unique_values_key_old;
CREATE UNIQUE INDEX chunks_unique_values_key ON chunks (course_id, type, coalesce(question_id, -1), coalesce(course_instance_id, -1), coalesce(assessment_id, -1));
