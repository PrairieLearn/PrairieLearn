...
ADD CONSTRAINT sharing_set_questions_question_id_fkey FOREIGN KEY (question_id) REFERENCES questions (id) ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE sharing_set_questions
ADD CONSTRAINT sharing_set_questions_sharing_set_id_fkey FOREIGN KEY (sharing_set_id) REFERENCES sharing_sets (id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ADD COLUMN IF NOT EXISTS sharing_name text;

ALTER TABLE pl_courses
ADD COLUMN IF NOT EXISTS sharing_id text;
