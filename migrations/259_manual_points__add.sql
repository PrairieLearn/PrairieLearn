...
ALTER TABLE instance_questions ADD COLUMN IF NOT EXISTS manual_score_perc DOUBLE PRECISION;
...
ALTER TABLE question_score_logs ADD COLUMN IF NOT EXISTS manual_score_perc DOUBLE PRECISION;
