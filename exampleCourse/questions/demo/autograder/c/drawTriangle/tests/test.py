#! /usr/bin/python3
import sys, math, sympy, json, base64, io
import cgrader
import itertools
...
class TestGrader(cgrader.CGrader):
    ...
    def tests(self):
        ...
        def generateOutput(l, x, y):
            ...
            return [' '.join(j) for j in
                    itertools.permutations([l1, l2, l3])]
        
        self.test_compile_file('drawTri.c', 'main',
            ...
            try:
                with open('image.json', 'r') as f:
                    ...
                    url = 'data:image/png;base64, ' + \
                          base64.encodebytes(buf.getvalue()).decode('ascii')
