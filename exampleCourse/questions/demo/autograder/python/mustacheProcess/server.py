...
WORD_CHOICES = ["knight", "duck", "herring", "hamster", "spam", "quest", "ministry", "grail", "silly", "parrot"]
FUN_CHOICES = ["foo", "bar", "baz", "quux"]

def generate(data):
    reordered_words = WORD_CHOICES[:]
    ...
    data["params"]["names_from_user"] = [
        {"name": function_name, "description": "the requested function", "type": "function (str -> str)"}
    ]
    data["params"]["pairs"] = pairs
