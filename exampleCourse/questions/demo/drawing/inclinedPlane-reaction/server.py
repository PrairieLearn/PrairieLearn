...
def generate(data):
    ...
    data["params"]["negative_normal_angle"] = angle + 90

    data["params"]["x5"] = x4 + circle_radius * math.cos(math.pi / 2 + theta_rad)
    data["params"]["y5"] = y4 + circle_radius * math.sin(math.pi / 2 + theta_rad)
