module.exports.b64EncodeUnicode2 = function(str) {
    ...
    return Buffer.from(encodeURIComponent(str, 'binary').replace(/%([0-9A-F]{2})/g, (match, p1) => {
        return String.fromCharCode('0x' + p1);
    })).toString('base64');
};

module.exports.b64DecodeUnicode2 = function(str) {
    // Going backwards: from bytestream, to percent-encoding, to original string.
    return decodeURIComponent(Buffer.from(str, 'base64').toString('binary').split('').map((c) => {
