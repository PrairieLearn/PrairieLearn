...
module.exports.connection = function(socket) {
    ...
    socket.on('getResults', (msg, callback) => {
        ...
        module.exports.renderPanelsForSubmission(msg.submission_id, msg.url_prefix, msg.question_context, msg.csrf_token, msg.authorized_edit, (err, panels) => {
...
module.exports.renderPanelsForSubmission = function(submission_id, urlPrefix, questionContext, csrfToken, authorizedEdit, callback) {
    question.renderPanelsForSubmission(submission_id, urlPrefix, questionContext, csrfToken, authorizedEdit, (err, results) => {
        if (ERR(err, callback)) return;
