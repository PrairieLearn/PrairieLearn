...
/**
 * Returns the directory where job files should be written to.
 */
module.exports.getJobDirectory = function(jobId) {
    return `${config.externalGradingFileStorePath}/job_${jobId}`;
};

module.exports.getS3RootKey = function(jobId) {
    return `job_${jobId}`;
};
