...
config.cronIntervalChunksHostLoadsSec = 10;
...
/**
 * The number of page views ... TODO finish.
 */
config.chunksPageViewsCapacityFactor = 10;
/**
 * The number of active workers ... TODO finish.
 */
config.chunksActiveWorkersCapacityFactor = 2;
/**
 * The number of requests a single chunk server should be able to handle per minute.
 */
