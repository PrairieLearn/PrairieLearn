...
config.autograderUseAws = false;
config.autograderJobsS3Bucket = 'prairielearn.autograder.jobs';
config.autograderResultsS3Bucket = 'prairielearn.autograder.results';
config.autograderArchivesS3Bucket = 'prairielearn.autograder.archives';
config.autograderJobQueue = 'autograder-job-queue';
config.autograderJobRole = 'arn:aws:iam::078374015580:role/AutograderContainer';
config.autograderWebhookSecret = 'thisisnotasecret';
config.autograderWebhookUrl = null;
