...
config.questionSharingEnabled = false;
config.ignoreQuestionImportFailures = true; // make sure this is never enabled in a production environment, becuase it will make a mess of the database with dummy questions
