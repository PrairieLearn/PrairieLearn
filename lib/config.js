...
config.workspaceS3Bucket = null;
config.workspaceContainerLocalhost = 'localhost';
config.workspaceContainerPort = 8081;
config.workspaceNativeLocalhost = 'host.docker.internal';
