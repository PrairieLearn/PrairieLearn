...
/**
 * Note that this should be set such that we're always deleting more rows
 * than we're inserting.
 */
...
/**
 * Controls how many rows are deleted in each batch when removing old rows
 * from the `time_series` table in the database.
 */
config.cleanTimeSeriesBatchSize = 100_000;
/**
