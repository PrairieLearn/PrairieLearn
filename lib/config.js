...
config.externalGradingJobsS3Bucket = 'prairielearn.autograder.jobs';
config.externalGradingResultsS3Bucket = 'prairielearn.autograder.results';
config.externalGradingArchivesS3Bucket = 'prairielearn.autograder.archives';
config.externalGradingJobQueue = 'autograder-job-queue';
config.externalGradingJobRole = 'arn:aws:iam::078374015580:role/AutograderContainer';
