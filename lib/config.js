...
config.workspaceDevHostPort = 8081;
config.workspaceDevContainerHostname = 'host.docker.internal';
config.workspaceGradedFilesMainDirectory = '/tmp'; // TODO: move out of /tmp
config.workspaceGradedFilesHostDirectory = '/tmp'; // TODO: move out of /tmp
