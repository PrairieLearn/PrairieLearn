...
config.externalGraderUseAws = false;
config.externalGraderJobsS3Bucket = 'prairielearn.autograder.jobs';
config.externalGraderResultsS3Bucket = 'prairielearn.autograder.results';
config.externalGraderArchivesS3Bucket = 'prairielearn.autograder.archives';
config.externalGraderJobQueue = 'autograder-job-queue';
config.externalGraderJobRole = 'arn:aws:iam::078374015580:role/AutograderContainer';
config.externalGraderWebhookUrl = null;
