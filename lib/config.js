...
config.courseDirs = ['/course',
                     ...
                     'exampleCourse',
                     'testCourse'];
config.courseCloneBranchDefault = 'master';
config.urlPrefix = '/pl';
config.homeUrl = '/';
...
config.instanceId = 'server'; // will be overridden by EC2 auto-detect	config.instanceId = 'server'; // FIXME: needs to be determed dynamically with new config code
