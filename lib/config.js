...
config.workersExecutionMode = 'container';
// 'course' will allocate a single worker per course
// 'random' will allocate N workers and randomly distribute jobs between them
config.workersAllocationStrategy = 'course';
