...
const { storageTypes } = require('../lib/file-store');
...
config.fileStoreS3Bucket = 'prairielearn.dev.file-store';
config.fileStoreStorageDefault = storageTypes.S3;
...
config.cronIntervalWorkspaceHostLoadsSec = 20;
