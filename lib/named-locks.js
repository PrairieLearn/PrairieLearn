 ...
 * @param {(err: Error | null | undefined, lock: Lock) => void} callback A callback(err, lock) function. If lock is null then it was not acquired.
 */
 ...
 * @param {(err: Error | null | undefined, lock?: Lock) => void} callback A callback(err, lock) function.
 */
 ...
 * @param {(err: Error | null | undefined) => void} failedCallback
 */
 ...
 * @param {(err: Error | null | undefined) => void} callback - A callback(err) function.
 */
