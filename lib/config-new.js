...
const { loadSqlEquiv, queryAsync, queryOneRowAsync, callAsync } = require('@prairielearn/postgres');
...
const ConfigSchema = z.object({
  ...
  /**
   * Where the workspace host server will store workspace files.
   */
...
// TODO: rename to just `loadConfig` once we've dropped the old sync config loading.
...
module.exports.setLocals = (locals) => {
...
module.exports.getDBConfigValueAsync = async function (key, defaultVal) {
  const result = await callAsync('config_select', [key]);
...
module.exports.getDBConfigValue = callbackify(module.exports.getDBConfigValueAsync);

module.exports.setDBConfigValueAsync = async function (key, value) {
  await queryOneRowAsync(sql.set_value, { key, value });
};
module.exports.setDBConfigValue = callbackify(module.exports.setDBConfigValueAsync);

module.exports.removeDBConfigValueAsync = async function (key) {
  await queryAsync(sql.remove_key, { key });
};
module.exports.removeDBConfigValue = callbackify(module.exports.removeDBConfigValueAsync);
