 ...
 * @property {boolean} [LoadUserOptions.pl_authn_cookie=true] - Create the cookie?
 * @property {boolean} [LoadUserOptions.redirect=false] - Redirect after processing?
 * @property {boolean} [LoadUserOptions.locals_authn=true] - Populate res.locals.authn*?
 */
 ...
 * @property {string} [LoadUserAuth.uid]
 * @property {string} [LoadUserAuth.uin]
 * @property {string} [LoadUserAuth.name]
 * @property {string} [LoadUserAuth.provider]
 * @property {number} [LoadUserAuth.user_id] - If present, skip the users_select_or_insert call
 */
/**
 *
