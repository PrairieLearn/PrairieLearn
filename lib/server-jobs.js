...
Job.prototype.addToStderr = function(text) {
    ...
    socketServer.io.to('job-' + this.id).emit('change:output', {job_id: this.id, output: ansifiedOutput});
};
...
module.exports.failJobSequenceAsync = util.promisify(module.exports.failJobSequence);
...
module.exports.getJobSequenceWithFormattedOutput = util.promisify(module.exports.getJobSequenceWithFormattedOutput);
