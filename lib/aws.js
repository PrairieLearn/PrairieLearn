 ...
 * @param {object?} options - Optional parameters, e.g., owner and group permissions (optional, defaults to {}).
 */
module.exports.downloadFromS3Async = async function (s3Bucket, s3Path, localPath, watcherUpdateQueue=null, options={}) {
    ...
    if (localPath.endsWith('/')) {
        ...
        if (!isNaN(options.owner) && !isNaN(options.group)) await fs.promises.chown(localPath, options.owner, options.group);
