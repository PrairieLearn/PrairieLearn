 ...
 * 
 * @param {boolean} isDirectory - Whether the upload source is a directory.
 ...
 */
module.exports.uploadToS3Async = async function (isDirectory, s3Bucket, s3Path, localPath) {
    const s3 = new AWS.S3();
 ...
 * 
 * @param {boolean} isDirectory - Whether the deletion target is a directory.
 * @param {string} s3Bucket - The S3 bucket name.
 * @param {string} s3Path - The S3 target path.
 */
module.exports.deleteFromS3Async = async function (isDirectory, s3Bucket, s3Path) {
    const s3 = new AWS.S3();
