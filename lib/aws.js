 ...
 * @param {string[]} patterns - An array of patterns of files to be retrieved, using micromatch rules.
 * @return {string[]}
 */
module.exports.listFilesFromS3Async = async function (s3Bucket, s3Prefix, patterns) {
  const s3 = new AWS.S3();
  let params = {
    Bucket: s3Bucket,
    Prefix: s3Prefix,
