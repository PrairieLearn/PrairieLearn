...
module.exports.downloadFromS3Async = async function (s3Bucket, s3Path, localPath, watcherUpdateQueue=null, forWorkspace=true) {
    ...
    if (localPath.endsWith('/')) {
        ...
        if (forWorkspace) await module.exports.changeWorkspaceFileOwnerAsync(localPath);
        ...
        if (forWorkspace) await module.exports.changeWorkspaceFileOwnerAsync(path.dirname(localPath));
    }
    ...
    return new Promise((resolve, reject) => {
        ...
        s3Stream.pipe(fileStream).on('error', function(err) {
            ...
            if (forWorkspace) {
                module.exports.changeWorkspaceFileOwner(localPath, (err) => {
 ...
 */
module.exports.changeWorkspaceFileOwnerAsync = async function (filePath) {
...
module.exports.changeWorkspaceFileOwner = util.callbackify(this.changeWorkspaceFileOwnerAsync);
