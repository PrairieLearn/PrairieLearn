...
module.exports = {
                    ...
                    csvConverter
                        ...
                        .subscribe((json, number) => {
                            return new Promise((resolve, _reject) => {
                                ...
                                module.exports._updateAssessmentInstanceFromJson(json, assessment_id, authn_user_id, create_instance_on_grading, (err) => {
                                    if (err) {
                                        errorCount++;
                                        const msg = String(err);
                                        if (output == null) {
    ...
    _updateAssessmentInstanceFromJson(json, assessment_id, authn_user_id, create_instance_on_grading, callback) {
        let query, id;
        if (_.has(json, 'uid')) {
        ...
        sqldb.queryZeroOrOneRow(query, params, function(err, result) {
            if (ERR(err, callback)) return;
