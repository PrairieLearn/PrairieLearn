...
module.exports = {
   ...
   * @return {Promise<number>} The job_sequence_id of the job sequence
   */
  uploadInstanceQuestionScoresAsync: async (assessment_id, csvFile, user_id, authn_user_id) => {
    ...
    const result = await sqldb.queryOneRowAsync(sql.select_assessment_info, params);
    ...
    const job_sequence_id = await serverJobs.createJobSequenceAsync(options);
