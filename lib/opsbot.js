...
module.exports.sendCourseRequestMessage = (msg, callback) => {
    ...
    const options = {
        ...
        json: {
            text: msg,
            channel: config.secretSlackCourseRequestChannel,
            icon_emoji: ':penguin:',
        },
    };
...
module.exports.sendCourseRequestMessageAsync = util.promisify((msg, callback) =>
    module.exports.sendCourseRequestMessage(msg, (err, res, body) => callback(err, {res, body})),
);
