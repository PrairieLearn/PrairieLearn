...
module.exports.sendMessage = (msg, callback) => {
  ...
  if (detectMocha())
    return callback(null, { statusCode: '200' }, 'Dummy test body');
...
module.exports.sendMessageAsync = util.promisify((msg, callback) =>
  module.exports.sendMessage(msg, (err, res, body) =>
...
module.exports.sendSlackAlmaMessage = (msg, channel, options, callback) => {
  ...
  request(default_options, (err, res, body) => {
    ...
    if (!body.ok) {
      callback(
        error.makeWithData(
          `Error sending message to ${default_options.json.channel}`,
          { body },
        ),
      );
      return;
...
module.exports.sendSlackAlmaMessageAsync = util.promisify(
  (msg, channel, options, callback) =>
    module.exports.sendSlackAlmaMessage(msg, (err, res, body) =>
      callback(err, { res, body }),
    ),
);
...
module.exports.sendProctorMessage = (msg, callback) => {
  module.exports.sendSlackAlmaMessage(
    msg,
    config.secretSlackProctorChannel,
    {},
    (err, res) => {
      if (ERR(err, callback)) return;
      callback(null, res);
...
module.exports.sendProctorMessageAsync = (msg) => {
  return module.exports.sendSlackAlmaMessageAsync(
    msg,
    config.secretSlackProctorChannel,
    {},
  );
