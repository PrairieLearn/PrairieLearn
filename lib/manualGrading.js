 ...
 * @param {Object} locals - The locals data to be used to render mustache tags.
 */
...
/** Builds the locals object for rubric grading data. Will typically be called twice for a
 * submission or grading job: once for manual grading, and once for auto grading. Returns an object
 * that is to be assigned to `rubric_grading_XXX` in the associated submission or grading job.
 *
 * @param {number} rubric_grading_id - The rubric grading being selected. Will typically be either manual_rubric_grading_id or auto_rubric_grading_id in the submission or grading job.
 * @returns {Promise<Object>}
 */
async function selectRubricGradingData(rubric_grading_id) {
  if (!rubric_grading_id) {
    return null;
  }
  return (
