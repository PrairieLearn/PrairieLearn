...
async function updateAssessmentQuestionRubric(
  ...
  await sqldb.runInTransactionAsync(async () => {
    ...
    if (use_rubrics) {
      ...
      await recomputeInstanceQuestions(assessment_question_id, rubric_type, authn_user_id);
    }
 ...
 * @param {number} authn_user_id - The user_id of the logged in user.
 */
async function recomputeInstanceQuestions(assessment_question_id, rubric_type, authn_user_id) {
  await sqldb.runInTransactionAsync(async () => {
...
async function updateInstanceQuestionScore(
  ...
  return sqldb.runInTransactionAsync(async () => {
    ...
    if (current_submission.auto_rubric_id && score?.auto_rubric_data?.rubric_id) {
      auto_rubric_grading = await insertRubricGrading(
