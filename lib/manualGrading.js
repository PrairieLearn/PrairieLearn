...
module.exports = {
  ...
  /**
   */
  insertRubricGrading: async (rubric_id, rubric_items, adjust_points) => {
    let result;
    await sqldb.runInTransactionAsync(async (client) => {
      result = module.exports._insertRubricGradingWithClient(
        client,
        rubric_id,
        rubric_items,
        adjust_points
  ...
  /**
   */
  _insertRubricGradingWithClient: async (client, rubric_id, rubric_items, adjust_points) => {
  ...
  /**
   */
  updateInstanceQuestionScore: async (
    assessment_id,
  ...
  /**
   */
  _updateInstanceQuestionScoreWithClient: async (
    client,
    assessment_id,
    assessment_instance_id,
    instance_question_id,
    ...
    const manual_rubric_grading_id = manual_rubric_data
      ? await module.exports._insertRubricGradingWithClient(
          client,
          manual_rubric_data.rubric_id,
          manual_rubric_data.applied_rubric_items,
          manual_rubric_data.adjust_points
        )
      : null;
    const auto_rubric_grading_id = auto_rubric_data
      ? await module.exports._insertRubricGradingWithClient(
          client,
