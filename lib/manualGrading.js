...
module.exports.nextUngradedInstanceQuestionUrl = async (
  ...
  if (result.rowCount > 0) {
    ...
    return `${urlPrefix}/instance_question/${instance_question_id}/manual_grading`;
  }
  // If we have no more submissions, then redirect back to manual grading page
  return `${urlPrefix}/assessment/${assessment_id}/assessment_question/${assessment_question_id}/manual_grading`;
};
