...
module.exports = {
     ...
     * @param {boolean | optional} toDatabase - Whether to write the message to the database.
     */
    ...
    /**
     * Updates a workspace's current state.
     *
     * @param {number} workspace_id - The workspace's id.
     * @param {string} state - The workspace's new state.
     * @param {string | optional} message - The workspace's new message.
     */
    ...
    async assignHost(workspace_id) {
        ...
        const result = await sqldb.queryAsync(sql.select_ready_workspace_hosts, {});
