...
module.exports = {
    ...
    async updateMessage(workspace_id, message) {
        ...
        const level = 'info';
        await sqldb.callAsync('workspaces_message_update', [workspace_id, level, {message}]);
    ...
    async updateState(workspace_id, state, message='') {
        ...
        const level = 'info';
        await sqldb.callAsync('workspaces_state_update', [workspace_id, level, state, params]);
