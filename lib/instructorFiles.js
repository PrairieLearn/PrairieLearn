 ...
 * @param {string} parentPath - the path of the parent directory. Assumed to be absolute.
 * @param {string} childPath - the path of the child directory. Usually absolute, but if relative, resolved in relation to the parent directory.
