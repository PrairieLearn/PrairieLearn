        ...
        if (question.autograding_enabled != true) {
          ...
          // Send the grade out for processing and display
            ...
            if (fs.existsSync(testsDir)) {
                copydir.sync(testsDir, path.join(dir, 'tests'));
            } else {
            ...
            // TODO this is currently hardcoded for the fibonacci demo, we should
            // change to the new submitted_answer format that includes all files
            // as named base64 strings
            fs.writeFileSync(path.join(dir, 'student', 'fib.py'), submission.submitted_answer.code)
