    ...
    if (groupConfig.has_roles) {
      ...
      if (currentSize > 1) {
        ...
        if (requiredGroupRoleIds.length > 0) {
          ...
          await sqldb.queryAsync(sql.clear_group_roles, { group_id: groupId });
