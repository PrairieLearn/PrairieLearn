...
//            logger.info(`No outcome to update for AI ${ai_id}`);
        ...
        request.post(post_params, function(err, httpResponse, body) {
            ...
            parser.parseString(body, (err, result) => {
                if (ERR(err, callback)) return;
                //console.log(_util.inspect(result, false, null));
                if (result.imsx_POXEnvelopeResponse.imsx_POXHeader.imsx_POXResponseHeaderInfo.imsx_statusInfo.imsx_codeMajor &&
                    result.imsx_POXEnvelopeResponse.imsx_POXHeader.imsx_POXResponseHeaderInfo.imsx_statusInfo.imsx_codeMajor == 'success') {
