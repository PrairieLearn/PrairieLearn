...
module.exports = {
     ...
     */
    assessment.makeAssessmentInstance(assessment_id, user_id, authn_user_id, mode, time_limit_min, date, course, callback) {
     ...
     */
    assessment.update(assessment_instance_id, authn_user_id, (err, updated) {
        sqldb.beginTransaction((err, client, done) => {
            if (ERR(err, callback)) return;
            async.series([
                (callback) => {
