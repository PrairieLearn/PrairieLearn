...
module.exports = {
     ...
     */
    makeAssessmentInstance(assessment_id, user_id, groupwork, authn_user_id, mode, time_limit_min, date, callback) {
        sqldb.beginTransaction((err, client, done) => {
            ...
            async.series([
                ...
                (callback) => {
                    ...
                    console.log(user_id, authn_user_id, assessment_id, groupwork);
