...
module.exports = {
     ...
     * @param {function} callback - A callback(err) function.
     */
    _gradeAssessmentInstanceWithClient(client, assessment_instance_id, authn_user_id, close, overrideGradeRate, student_identity, callback) {
        ...
        async.series([
            ...
            (callback) => {
                async.eachSeries(rows, (row, callback) => {
                    ...
                    question._gradeVariantWithClient(client, row.variant, check_submission_id, row.question, row.course, authn_user_id, overrideGradeRate, student_identity, (err, grading_job_id) => {
                        if (ERR(err, callback)) return;
     ...
     * @param {function} callback - A callback(err) function.
     */
    gradeAssessmentInstance(assessment_instance_id, authn_user_id, close, overrideGradeRate, student_identity, callback) {
        ...
        sqldb.beginTransaction((err, client, done) => {
            ...
            async.series([
                ...
                (callback) => {
                    this._gradeAssessmentInstanceWithClient(client, assessment_instance_id, authn_user_id, close, overrideGradeRate, student_identity, (err, ret_grading_job_ids) => {
                        if (ERR(err, callback)) return;
