 ...
 * @param {boolean=true} includeSelf - return valud if both paths point to the same directory.
 * @return {boolean} true if the child path is a child of the parent path, false otherwise.
 */
module.exports.parentContainsChild = function (parentPath, childPath, includeSelf = true) {
