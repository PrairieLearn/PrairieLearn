...
module.exports = {
    ...
    */
    ...
    /**
     * Renders a complete submission panel for externally graded jobs. This
     * includes the panel frame, submission status, etc.
     * @param  {[type]}   grading_job_id [description]
     * @param  {[type]}   urlPrefix      [description]
     * @param  {Function} callback       [description]
     * @return {[type]}                  [description]
     */
    renderSubmissionPanelForGradingJob(grading_job_id, urlPrefix, callback) {
        const params = {
            grading_job_id,
        };
        sqldb.queryOneRow(sql.select_grading_job_info, params, (err, results) => {
            if (ERR(err, callback)) return;
