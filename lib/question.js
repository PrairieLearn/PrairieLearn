        ...
        sqldb.beginTransaction((err, client, done) => {
            ...
            async.series([
                (callback) => {
                    ...
                    // _saveS3FileUploads(body);
                    // if (submission.submitted_answer.__s3_upload) this._saveS3FileUploads(client, submission, variant, question, course, assessment);
                    // this._saveSubmissionWithClient(client, submission, variant, question, course, assessment, (err, ret_submission_id) => {
