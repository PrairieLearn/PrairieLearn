...
module.exports = {
    ...
    _writeCourseErrs(client, courseErrs, variant_id, authn_user_id, studentMessage, courseData, callback) {
        async.eachSeries(courseErrs, (courseErr, callback) => {
            ...
            console.log('_writeCourseErrs', 'params', params);
            if (client) {
    ...
    getAndRenderVariant(variant_id, locals, callback) {
        ...
        if (!locals.assessment) {
            ...
            locals.newVariantUrl = locals.urlPrefix + '/question/' + locals.question.id + '/';
            locals.tryAgainUrl = locals.urlPrefix + '/question/' + locals.question.id + '/';
            locals.reloadUrl = locals.urlPrefix + '/question/' + locals.question.id + '/';
            locals.clientFilesQuestionUrl = locals.urlPrefix + '/question/' + locals.question.id + '/clientFilesQuestion';
            locals.calculationQuestionFileUrl = locals.urlPrefix + '/question/' + locals.question.id + '/file';
            locals.calculationQuestionGeneratedFileUrl = locals.urlPrefix + '/question/' + locals.question.id + '/generatedFilesQuestion';
            ...
            locals.newVariantUrl = locals.urlPrefix + '/instance_question/' + locals.instance_question.id;
            locals.tryAgainUrl = locals.urlPrefix + '/instance_question/' + locals.instance_question.id;
            locals.reloadUrl = locals.urlPrefix + '/instance_question/' + locals.instance_question.id + '/?variant_id=' + locals.variant.id;
            locals.clientFilesQuestionUrl = locals.urlPrefix + '/instance_question/' + locals.instance_question.id + '/clientFilesQuestion';
            locals.calculationQuestionFileUrl = locals.urlPrefix + '/instance_question/' + locals.instance_question.id + '/file';
            locals.calculationQuestionGeneratedFileUrl = locals.urlPrefix + '/instance_question/' + locals.instance_question.id + '/generatedFilesQuestion/variant/' + locals.variant.id;
