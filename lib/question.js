            ...
            (callback) => {
                ...
                sqldb.query(sql.select_submissions, params, (err, result) => {
                    ...
                    if (result.rowCount >= 1) {
                        ...
                        locals.nextSubmissionLeftMS = 0;
                        locals.submissions.forEach((submission) => {
                            if (submission.next_submission_left_ms > locals.nextSubmissionLeftMS) {
                                locals.disableGradeButton = true;
                                locals.nextSubmissionLeftMS = submission.next_submission_left_ms;
                                locals.nextSubmissionFormattedDate = submission.next_submission_formatted_date;
                            }
                        });
