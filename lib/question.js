...
module.exports = {
      ...
      [
        ...
        (callback) => {
          ...
          const submissionKeys = [
            ...
            'format_errors',
            'gradable',
            'grading_method_internal',
            'grading_method_external',
            'grading_method_manual',
            'partial_scores',
  ...
  _buildLocals(
    ...
    if (question && question.grading_method_manual) {
      locals.showGradeButton =
        question.grading_method_internal || question.grading_method_external ? true : false;
