      ...
      [
        ...
        async () => {
          if (locals.instance_question) {
            ...
            await async.each(locals.submissions, async (submission) => {
              submission.rubric_grading_manual = await manualGrading.selectRubricGradingData(
                submission.manual_rubric_grading_id
              );
              submission.rubric_grading_auto = await manualGrading.selectRubricGradingData(
