            ...
            function(callback) {
                if (variant_id != null) {
                    ...
                    sqldb.beginTransaction(function(err, client, done) {
                        ...
                        module.exports.ensureVariant(client, instance_question_id, locals.user.user_id, locals.authn_user.user_id, locals.question, locals.course, {}, require_open, function(err, variant) {
                            if (ERR(err, callback)) return;
