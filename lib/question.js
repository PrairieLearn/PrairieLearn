...
=======
                // We always want to call the internal grader in case it can help grade external / manual questions with internal parts
                questionModule.grade(submission, variant, question, course, (err, ret_courseIssues, ret_data) => {
>>>>>>> f9c3fa83dab4edd3bdd9b4c439d2cd3a9884c71e
                        if (ERR(err, callback)) return;
                        courseIssues = ret_courseIssues;
                        data = ret_data;
                        const hasFatalIssue = _.some(_.map(courseIssues, 'fatal'));
