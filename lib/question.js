    ...
    */
        ...
        async.series([
            ...
            (callback) => {
                if (!data.broken && grading_job.grading_method == 'External') {
                    externalGrader.sendToGradingQueue(grading_job, submission, variant, question, course);
    ...
    getAndRenderVariant(variant_id, locals, callback) {
        ...
        async.series([
            ...
            (callback) => {
                sqldb.query(sql.assessment_question_stats, {question_id: locals.question.id}, function(err, result) {
                    if (ERR(err, callback)) return;
                    locals.assessment_stats = result.rows;
                    callback(null);
                });
            },
            (callback) => {
                locals.question_attempts_histogram = null;
                locals.question_attempts_before_giving_up_histogram = null;
                locals.question_attempts_histogram_hw = null;
                locals.question_attempts_before_giving_up_histogram_hw = null;
