...
module.exports = {
    ...
    */
     ...
     * @param {number} authn_user_id - The current authenticated user.
     * @param {boolean} groupwork - Whether the assessment is groupwork.
     * @param {Object} course - The course for the variant.
     * @param {Object} options - Options controlling the creation: options = {variant_seed}
     ...
     * @param {number} user_id - The user for the new variant.
     * @param {number} authn_user_id - The current authenticated user.
     * @param {boolean} groupwork - The current assessment is groupwork.
        ...
        async.series([
            (callback) => {
                if (variant_id != null) {
                    ...
                    this.ensureVariant(locals.question.id, instance_question_id, locals.user.user_id, locals.authn_user.user_id,locals.assessment.groupwork, course_instance_id, locals.course, options, require_open, (err, variant) => {
                        if (ERR(err, callback)) return;
