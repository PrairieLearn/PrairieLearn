...
module.exports = {
    ...
    */
    ...
    _saveSubmissionWithClient(client, submission, variant, question, course, callback) {
        ...
        let requiredFileNames, contents;
        async.series([
            (callback) => { // if workspace question, get graded files first
                if (question.workspace_image !== null) {
                    // TODO: un-hardcode requiredFileNames
                    requiredFileNames = [
                        // 'project/starter_code.py',
                        'starter_code.py',
                    ];
...
`;
                    ...
                    logger.info(`... not a workspace question (image=null)`);
                }
                callback(null);
            },
            (callback) => {
            ...
            (callback) => {
                questionModule.parse(submission, variant, question, course, (err, ret_courseIssues, ret_data) => {
                    ...
                    if (question.workspace_image !== null) {
                        ...
                        data['params']['_required_file_names'] = requiredFileNames;
