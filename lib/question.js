...
module.exports = {
    ...
    */
    ...
    async _saveS3FileUploads(submission, client, assessment) {
        ...
        for await (const file of files) {
            await fileStore.upload(file.name, file.contents, 'student_upload', assessment.id, null, null, null, fileStore.storageTypes.S3);
        }
