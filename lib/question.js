...
module.exports = {
   ...
   * @param {boolean} allowOldSubmission - Avoid bailing if we try to grade an old submission.
   * @param {function} callback - A callback(err) function.
   */
  gradeVariant(
    variant,
    ...
    async.series(
      [
        (callback) => {
          var params = [variant.id, check_submission_id, allowOldSubmission];
