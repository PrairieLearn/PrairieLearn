...
module.exports = {
    ...
    */
     ...
     * @param {number} authn_user_id - The current authenticated user.
     * @param {boolean} groupwork - If the assessment will support group work
     * @param {Object} course - The course for the variant.
     * @param {Object} options - Options controlling the creation: options = {variant_seed}
     * @param {function} callback - A callback(err, variant) function.
     */
    _makeAndInsertVariantWithClient(client, question_id, instance_question_id, user_id, authn_user_id, groupwork, course_instance_id, course, options, callback) {
     ...
     * @param {function} callback - A callback(err, variant) function.
     */
    _ensureVariantWithClient(client, question_id, instance_question_id, user_id, authn_user_id, groupwork, course_instance_id, course, options, require_open, callback) {
        if (instance_question_id != null) {
            ...
            sqldb.callWithClient(client, 'instance_questions_select_variant', params, (err, result) => {
                ...
                this._makeAndInsertVariantWithClient(client, question_id, instance_question_id, user_id, authn_user_id, groupwork, course_instance_id, course, options, (err, variant) => {
                    if (ERR(err, callback)) return;
     ...
     * @param {function} callback - A callback(err, variant) function.
     */
    ensureVariant(question_id, instance_question_id, user_id, authn_user_id, groupwork, course_instance_id, course, options, require_open, callback) {
        let variant;
        sqldb.beginTransaction((err, client, done) => {
            ...
            async.series([
                ...
                (callback) => {
                    this._ensureVariantWithClient(client, question_id, instance_question_id, user_id, authn_user_id, groupwork, course_instance_id, course, options, require_open, (err, ret_variant) => {
                        if (ERR(err, callback)) return;
                        variant = ret_variant;
                        callback(null);
                    });
     ...
     * @param {function} callback - A callback(err, variant) function.
     */
    _testQuestion(question, groupwork, course_instance, course, test_type, authn_user_id, callback) {
        debug('_testQuestion()');
        ...
        sqldb.beginTransaction((err, client, done) => {
            ...
            async.series([
                (callback) => {
                    ...
                    this._ensureVariantWithClient(client, question.id, instance_question_id, authn_user_id, authn_user_id, groupwork, course_instance.id, course, options, require_open, (err, ret_variant) => {
                        if (ERR(err, callback)) return;
                        variant = ret_variant;
     ...
     */
    _runTest(logger, showDetails, question, groupwork, course_instance, course, test_type, authn_user_id, callback) {
        let variant, expected_submission, test_submission, success = true;
        async.series([
            (callback) => {
                logger.verbose('Testing ' + question.qid);
                this._testQuestion(question, groupwork, course_instance, course, test_type, authn_user_id, (err, ret_variant, ret_expected_submission, ret_test_submission) => {
                    if (ERR(err, callback)) return;
                    variant = ret_variant;
                    expected_submission = ret_expected_submission;
                    test_submission = ret_test_submission;
     ...
     */
    startTestQuestion(count, showDetails, question, groupwork, course_instance, course, authn_user_id, callback) {
        let success = true;
        const options = {
            course_id: course.id,
        ...
        serverJobs.createJobSequence(options, (err, job_sequence_id) => {
            ...
            serverJobs.createJob(jobOptions, (err, job) => {
                ...
                async.eachSeries(_.range(count * test_types.length), (iter, callback) => {
                    ...
                    this._runTest(job, showDetails, question, groupwork, course_instance, course, type, authn_user_id, (err, ret_success) => {
                        if (ERR(err, callback)) return;
        ...
        async.series([
            (callback) => {
                if (variant_id != null) {
                    ...
                    const assessment_groupwork = locals.assessment ? locals.assessment.groupwork : false;
                    this.ensureVariant(locals.question.id, instance_question_id, locals.user.user_id, locals.authn_user.user_id, assessment_groupwork, course_instance_id, locals.course, options, require_open, (err, variant) => {
                        if (ERR(err, callback)) return;
