...
module.exports = {
     ...
     * @param {boolean} ok_to_not_grade - If true, no error will be raised if the variant did not need grading.
     ...
     * @param {function} callback - A callback with arguments (err).
     */
    gradeVariant: function(variant, check_submission_id, ok_to_not_grade, question, course, authn_user_id, callback) {
        ...
        sqldb.beginTransaction(function(err, client, done) {
            ...
            async.series([
                ...
                (callback) => {
                    ...
                    sqldb.callWithClientOneRow(client, 'variants_grade', params, function(err, result) {
                        if (ERR(err, callback)) return;
    ...
    oldGradeSavedSubmission: function(client, submission_id, auth_user_id, variant, question, course, callback) {
