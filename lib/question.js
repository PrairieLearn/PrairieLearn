...
module.exports = {
    ...
    * @param {Object} question - The question for the variant.
    * @param {Object} course - The course for the variant.
    * @param {Object} authn_user_id
    * @param {function} callback - A callback(err, courseErrs, fileData) function.
    */
        ...
        async.series([
            ...
            (callback) => {
                if (!locals.assessment) {
                    ...
                    locals.clientFilesCourseInstanceUrl = locals.urlPrefix + '/clientFilesCourseInstance';
                    locals.clientFilesAssessmentUrl = locals.urlPrefix + '/assessment/' + locals.assessment.id + '/clientFilesAssessment';
