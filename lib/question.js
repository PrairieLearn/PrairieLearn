...
module.exports = {
    ...
    */
    ...
    _saveSubmissionWithClient(client, submission, variant, question, course, callback) {
        ...
        let questionModule, courseIssues, data, submission_id, workspace_id;
        ...
        async.series([
            ...
            (callback) => { // if workspace, encode graded files into _files
                if (question.workspace_image !== null) {
                    ...
                    const zipName = `${zipPrefix}/workspace-${workspace_id}-graded-files.zip`;
                    logger.info(`... reading ${zipName}`);
                    ...
                    zipEntries.forEach((zipEntry) => {
                        ...
                        logger.info(`... appending zipEntry: ${zipEntry.entryName}`);
                    ...
                    fs.unlink(zipName, (err) => {
                        if(ERR(err, callback)) return;
                        logger.info(`... deleting graded files: ${zipName}`);
                        callback(null);
                    });
                } else {
                    callback(null);
