 ...
 * @param {(err: Error | null | undefined, data?: any) => void} callback Invoked with the resolved JSON data or an error
 */
 ...
 * @param {(err: Error | null | undefined, json?: any) => void} callback Invoked with the original JSON data or an error
 */
 ...
 * @param {(err: Error | null | undefined, json?: any) => void} callback Invoked with the validated JSON or an error
 */
