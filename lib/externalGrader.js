...
//const ExternalGraderECS = require('./externalGraderECS');
//const ExternalGraderBatch = require('./externalGraderBatch');
...
module.exports.init = function(assessment, callback) {
    ...
    if (config.externalGradingUseAws) {
        ...
        /*if (config.externalGradingUseBatch) {
            AWS.config.update({region: 'us-east-1'});
            module.exports.grader = new ExternalGraderBatch();
        } else {
            AWS.config.update({region: 'us-east-2'});
            module.exports.grader = new ExternalGraderECS();
        }*/
        AWS.config.update({region: 'us-east-2'});
