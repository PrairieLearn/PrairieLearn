"""Test that non-preloaded stdlib modules are importable after privilege drop.

This question exists solely to catch regressions like
...
many stdlib modules, so most question code works fine even when the stdlib
path is inaccessible. This question deliberately imports modules that are NOT
