...
setup_pt_courses AS (
    INSERT INTO pt_courses (id, name) VALUES
        (1, 'Course 1')
),
setup_pt_sessions AS (
    INSERT INTO pt_sessions (id) VALUES
        (1)
),
setup_pt_enrollments AS (
    INSERT INTO pt_enrollments (id, user_id) VALUES (1, 1000)
),
setup_pt_exams AS (
    INSERT INTO pt_exams (id, uuid, name, course_id) VALUES
        (1, '890884f9-aa9d-4fc0-b910-5229794906fb', 'Exam 1', 1)
),
setup_pl_course AS (
...
insert_new_reservation AS (
    INSERT INTO pt_reservations (exam_id, enrollment_id, session_id, access_start, access_end) VALUES
        ($exam_id, 1, 1, '2010-07-01 00:00:00-00', '2010-07-31 23:59:59-00')
)
SELECT true;
