...
describe('sproc check_assessment_access* tests', function () {
  ...
  describe('check_assessment_access allowAccess parameter tests', () => {
    it('should pass when rule role is Student', (callback) => {
      let params = [
        50,
        'Public',
        'None',
    ...
    it('should pass when mode, uid, start_date, and end_date matches', (callback) => {
      let params = [
        50,
        'Public',
        'None',
    ...
    it('should fail when mode does not match', (callback) => {
      let params = [
        50,
        'Exam',
        'None',
    ...
    it('should fail when uid not in uids', (callback) => {
      let params = [
        50,
        'Exam',
        'None',
    ...
    it('should fail when attempt date is before start_date', (callback) => {
      let params = [
        50,
        'Exam',
        'None',
    ...
    it('should fail when attempt date is after end_date', (callback) => {
      let params = [
        50,
        'Exam',
        'None',
...
I have a checked in reservation
- view only allowed exam (enforce exam_uuid matches)
- do not view other exams (because exam_uuid won't match or is missing)
I do not have a checked in reservation
- view any mode:Exam that is unprotected by exam_uuid
