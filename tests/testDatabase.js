...
describe('database', function() {
    ...
    it('should not contain "ON DELETE CASCADE" foreign keys from soft-delete to hard-delete tables', function(done) {
        ...
        databaseDescribe.describe(options, (err, data) => {
            ...
            const tableHasDeletedAtColumn = table => _.some(data.tables[table].columns, {'name': 'deleted_at'});
            const [softDeleteTables, hardDeleteTables] = _.partition(_.keys(data.tables), tableHasDeletedAtColumn);
