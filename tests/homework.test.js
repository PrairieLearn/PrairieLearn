    ...
    describe('setting up the submission data', function () {
      it('should succeed', function () {
        ...
        locals.expectedResult = {
          ...
          instance_question_auto_score_perc: (2 / 11) * 100,
    ...
    describe('setting up the submission data', function () {
      it('should succeed', function () {
        ...
        locals.expectedResult = {
          ...
          instance_question_auto_score_perc: (3 / 14) * 100,
          instance_question_manual_points: 0,
    ...
    describe('setting up the submission data', function () {
      it('should succeed', function () {
        ...
        locals.expectedResult = {
          ...
          instance_question_auto_score_perc: (4 / 11) * 100,
          instance_question_manual_points: 0,
    ...
    describe('setting up the submission data', function () {
      it('should succeed', function () {
        ...
        locals.expectedResult = {
          ...
          instance_question_auto_score_perc: (8 / 11) * 100,
          instance_question_manual_points: 0,
    ...
    describe('setting up the submission data', function () {
      it('should succeed', function () {
        ...
        locals.expectedResult = {
          ...
          instance_question_auto_score_perc: (1 / 5) * 100,
          instance_question_manual_points: 0,
    ...
    describe('setting up the submission data', function () {
      it('should succeed', function () {
        ...
        locals.expectedResult = {
          ...
          instance_question_auto_score_perc: (9 / 14) * 100,
          instance_question_manual_points: 0,
    ...
    describe('setting up the submission data', function () {
      it('should succeed', function () {
        ...
        locals.expectedResult = {
          ...
          instance_question_auto_score_perc: (12 / 14) * 100,
          instance_question_manual_points: 0,
    ...
    describe('setting up the submission data', function () {
      it('should succeed', function () {
        ...
        locals.expectedResult = {
          ...
          instance_question_auto_points: 0,
          instance_question_auto_score_perc: (0 / 8) * 100,
          instance_question_manual_points: 0,
          assessment_instance_points: 26,
          assessment_instance_score_perc: (26 / assessmentMaxPoints) * 100,
        };
    ...
    describe('setting up the submission data', function () {
      it('should succeed', function () {
        ...
        locals.expectedResult = {
          ...
          instance_question_auto_points: 3,
          instance_question_auto_score_perc: (3 / 8) * 100,
          instance_question_manual_points: 0,
