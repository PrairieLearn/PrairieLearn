...
class BaseElement:
    def generate(_element, _data):
        return {}

    def is_gradable():
        return False

    def grade(ref, _student, _tol, _angtol):
        return True

    def grading_name(_element):
        return None
...
class UnplaceableBaseElement(BaseElement):
    ...
    def grade(ref, _st, _tol, _angtol):
        raise Exception(
