...
def render(element_html, data):
    ...
    for child in element:
        if child.tag == "variable":
            ...
            if var_data is None:
                msg = f'No value in data["params"] for variable {var_name} in pl-matrix-output element'
                raise Exception(
                    msg
                )
            ...
            if np.isscalar(var_data):
                ...
                if var_data.ndim != 2:
                    msg = f'Value in data["params"] for variable {var_name} in pl-matrix-output element must be a scalar or a 2D array'
                    raise Exception(
                        msg
                    )
