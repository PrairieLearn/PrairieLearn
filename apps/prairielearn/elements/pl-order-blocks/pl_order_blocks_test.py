...
def test_wrap_inline_validation(options: dict) -> None:
    """Tests pl-answer wrap-inline option validation"""
    question = build_tag(
        tag_name="pl-order-blocks",
        options=options,
        inner_html=build_tag("pl-answer", {"correct": True}),
...
def test_wrap_inline_validation_failure(options: dict, error: str) -> None:
    """Tests pl-answer wrap-inline option failure"""
    question = build_tag(
        tag_name="pl-order-blocks",
        options=options,
        inner_html=build_tag("pl-answer", {"correct": True}),
