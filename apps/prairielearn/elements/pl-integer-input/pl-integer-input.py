...
def prepare(element_html: str, data: pl.QuestionData) -> None:
    ...
    if base != 0 and (base < 2 or base > 36):
        msg = f"Base must be either 0, or between 2 and 36, not {base}"
...
def render(element_html: str, data: pl.QuestionData) -> str:
    ...
    if data["panel"] == "question":
        ...
        if parse_error is None and name in data["submitted_answers"]:
            ...
            if a_sub is None:
                msg = f"Submitted answer is None for {name}"
                raise ValueError(msg)
...
def parse(element_html: str, data: pl.QuestionData) -> None:
    ...
    if a_sub_parsed is None:
        ...
        # The base used for the answer is ignored in this storage
...
def test(element_html: str, data: pl.ElementTestData) -> None:
    ...
    if a_tru_parsed is None:
        msg = f"Could not parse correct answer: {a_tru}"
        raise ValueError(msg)
