...
print("importing base modules took", time.time() - start, "seconds")

print("importing prairielearn modules")
start = time.time()

import prairielearn.internal.zygote_utils as zu
from prairielearn.internal import question_phases

print("importing prairielearn modules took", time.time() - start, "seconds")
...
print("importing third-party modules took", time.time() - start, "seconds")

mpl.use("PDF")

print("constructing unit registry")
start = time.time()

# Construct initial unit registry to create initial cache file.
prairielearn.get_unit_registry()

print("constructing unit registry took", time.time() - start, "seconds")
