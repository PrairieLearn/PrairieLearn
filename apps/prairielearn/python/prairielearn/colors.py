...
PL_COLORS_NAME_MAP: dict[str, ColorTuple] = {
    ...
    "blue3": (0, 87, 160, 255),
    "brown": (125, 86, 64, 255),
    "brown1": (230, 191, 168, 255),
    "brown2": (192, 149, 124, 255),
    "brown3": (125, 86, 64, 255),
    ...
    "green3": (0, 140, 49, 255),
    "incorrect_red": (199, 44, 28, 255),
    "orange1": (255, 220, 181, 255),
    "orange2": (255, 146, 107, 255),
    "orange3": (195, 82, 43, 255),
    ...
    "yellow1": (253, 238, 165, 255),
    "yellow2": (245, 206, 50, 255),
    "yellow3": (214, 161, 0, 255),
}
