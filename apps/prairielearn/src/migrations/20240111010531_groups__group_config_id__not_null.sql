...
DELETE FROM groups WHERE group_config_id IS NULL;
...
ALTER TABLE groups ADD CONSTRAINT groups_group_config_id_not_null CHECK (group_config_id IS NOT NULL) NOT VALID;
