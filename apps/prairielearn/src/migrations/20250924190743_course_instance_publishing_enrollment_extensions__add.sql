...
CREATE INDEX course_instance_publishing_enrollment_extensions_enrollment_id_idx ON course_instance_publishing_enrollment_extensions (enrollment_id);

-- Quickly lookup all entries in this table for a given extension.
CREATE INDEX course_instance_publishing_enrollment_extensions_course_instance_publishing_extension_id_idx ON course_instance_publishing_enrollment_extensions (course_instance_publishing_extension_id);
