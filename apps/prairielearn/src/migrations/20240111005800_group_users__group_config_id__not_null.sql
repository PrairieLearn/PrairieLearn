...
DELETE FROM group_users WHERE group_config_id IS NULL;
...
ALTER TABLE group_users ADD CONSTRAINT group_users_group_config_id_not_null CHECK (group_config_id IS NOT NULL) NOT VALID;
