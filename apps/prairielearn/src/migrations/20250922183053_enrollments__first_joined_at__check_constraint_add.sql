...
ADD CONSTRAINT first_joined_at_not_null_if_joined_and_created_at_not_null CHECK (
  ...
  -- Enforce that if the status is 'joined', 'removed', or 'blocked', then the first_joined_at is not null.
  -- You can only be removed or blocked if you were joined at some point.
