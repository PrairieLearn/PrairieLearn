...
export const AI_GRADING_MODELS = [
  {
    ...
    name: 'GPT 5.6 Luna',
    sublabel: 'Best for text-based submissions at scale',
    recommended: true,
  },
  {
    provider: 'openai',
    ...
    name: 'GPT 5.6 Terra',
    sublabel: 'Best for general-purpose text-based submissions',
    recommended: true,
  },
  {
    provider: 'openai',
    modelId: 'gpt-5.6-sol',
    name: 'GPT 5.6 Sol',
    sublabel: 'Best for complex text-based submissions',
    recommended: false,
  },
  {
    provider: 'openai',
    modelId: 'gpt-6-astra',
    name: 'GPT 6 Astra',
    sublabel: 'Best for demanding text-based submissions',
    recommended: false,
  },
  {
    provider: 'google',
