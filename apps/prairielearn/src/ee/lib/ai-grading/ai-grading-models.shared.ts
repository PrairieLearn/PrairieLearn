...
export const AI_GRADING_MODELS = [
  {
    ...
    name: 'GPT 5.6 Luna',
    sublabel: 'Best for low-cost text grading at scale',
    recommended: true,
  },
  {
    provider: 'openai',
    ...
    name: 'GPT 5.6 Terra',
    sublabel: 'Best balance of accuracy and cost for text grading',
    recommended: true,
  },
  {
    provider: 'openai',
    modelId: 'gpt-5.6-sol',
    name: 'GPT 5.6 Sol',
    sublabel: 'Advanced reasoning for complex text grading',
    recommended: false,
  },
  {
    provider: 'openai',
    modelId: 'gpt-6-astra',
    name: 'GPT 6 Astra',
    sublabel: 'Most capable for demanding text grading',
    recommended: false,
  },
  {
    provider: 'google',
    ...
    sublabel: 'Best for handwriting and image grading',
    recommended: true,
  },
  {
    provider: 'google',
    ...
    name: 'Gemini 3.1 Pro',
    sublabel: 'Deeper reasoning for complex handwriting and image grading',
    recommended: false,
  },
  {
    provider: 'anthropic',
    ...
    sublabel: 'Best for low-cost code grading at scale',
    recommended: false,
  },
  {
    provider: 'anthropic',
  ...
  },
  {
    ...
    name: 'Claude Opus 5',
    sublabel: 'Advanced reasoning for complex code grading',
    recommended: false,
  },
  {
    provider: 'anthropic',
    ...
    sublabel: 'Most capable for demanding code grading',
    recommended: false,
  },
] as const;
