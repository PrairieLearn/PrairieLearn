      ...
      ${hasRosterSyncPermitted
        ? html`
            <div class="alert alert-info" id="saml-lti-roster-sync-dependencies">
              ...
              <p class="mb-0">
                The SAML issuer and UIN attribute are locked. Disable roster syncing permission for
                every listed instance before changing them or deleting this configuration.
              </p>
            </div>
          `
        : ''}
