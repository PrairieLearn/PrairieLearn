            ...
            <div class="card-body">
              ${!prompts || prompts.length <= 0
                ? html`<div id="generation-prompter">
                    <p>
                      Please describe your question in as much detail as possible in the box below.
                    </p>
                    <form
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-text form-muted">
                          <em>
                            ...
                            integer between 1 and 4 m/s. How long does it take for the car to reach
                            the ground?
                          </em>
                        </div>
                        <label for="user-prompt-llm-user-input">
                          How should students input their solution? What choices or input boxes are
                          they given?
                        </label>
                        <textarea
