  ...
  return PageLayout({
    ...
    content: html` <div class="mb-3">
      ...
      <div id="ai-grading-card" class="card mb-5 mx-auto overflow-hidden" style="max-width: 700px">
        <h3 class="text-center">AI Grading</h1>
        <form id="ai-grading-form" name="ai-grading-form" method="POST">
          <input type="hidden" name="__csrf_token" value="${resLocals.__csrf_token}" />
          <small class="form-text text-muted">More customizations will be enabled here in the future.</small>
					<div>
						<button type="submit" class="btn btn-success" name="__action" value="ai_grade_assessment">
							Grade All
						</button>
						<button
							type="submit"
