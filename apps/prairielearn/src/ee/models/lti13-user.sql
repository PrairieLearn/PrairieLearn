...
SELECT
  ...
  to_jsonb(lti13_users.*) AS lti13_user
FROM
  JOIN lti13_course_instances
...
WHERE
  lti13_users.user_id = $user_id
  AND lti13_course_instances.course_instance_id = $course_instance_id;
