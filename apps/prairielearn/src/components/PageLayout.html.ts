...
/**
 * Manages rendering the head, navbar, and content of a page.
 *
 ...
 * @param {options.fullWidth} - Whether the main container should span the full width.
 * @param {options.marginBottom} - Whether the main container should have a bottom margin of mb-4 in Bootstrap.
 * @param {options.pageNote} - A note to display after the title, shown in parenthesis.
 * @param {options.navSubPage} - The subpage to highlight in the navbar.
