...
function formJsonToEnrollmentRuleData(
  ...
  return {
    ...
    questionsHidden:
      ac?.questions && 'hidden' in ac.questions ? ac.questions.hidden : null,
    questionsVisibleFromOverridden: ac?.questions?.visibleFrom !== undefined,
    questionsVisibleFrom: ac?.questions?.visibleFrom ?? null,
    questionsVisibleUntilOverridden: ac?.questions?.visibleUntil !== undefined,
    questionsVisibleUntil: ac?.questions?.visibleUntil ?? null,
    scoreHidden: ac?.score && 'hidden' in ac.score ? ac.score.hidden : null,
    scoreVisibleFromOverridden: ac?.score?.visibleFrom !== undefined,
    scoreVisibleFrom: ac?.score?.visibleFrom ?? null,
