...
module.exports = {
   ...
   * @param {string | number| null} check_submission_id - The submission_id that must be graded (or null to skip this check).
   * @param {Object} question - The question for the variant.
   * @param {Object} course - The course for the variant.
   * @param {string | number | null} authn_user_id - The currently authenticated user.
