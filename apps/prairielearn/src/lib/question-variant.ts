 ...
 * @param options.variant - The variant.
 * @param options.submission - The submission, or null if this is not a submission file.
 * @param options.question - The question for the variant.
