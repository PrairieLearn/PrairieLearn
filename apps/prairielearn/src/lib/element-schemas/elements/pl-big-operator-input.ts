...
const plBigOperatorInputAttributesSchema = z
  .object({
    ...
    'correct-answer-body': z.string().optional(),
    'correct-answer-domain': z.string().optional(),
    'correct-answer-end': z.string().optional(),
    'correct-answer-start': z.string().optional(),
    'correct-answer-target': z.string().optional(),
