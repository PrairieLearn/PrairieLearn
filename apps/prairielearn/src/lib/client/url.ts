...
export function getAssessmentQuestionTrpcChunkUrl({
  courseInstanceId,
  assessmentId,
  assessmentQuestionId,
}: {
  ...
  return `/pl/course_instance/${courseInstanceId}/instructor/assessment/${assessmentId}/assessment_question/${assessmentQuestionId}/trpc-chunk`;
}
