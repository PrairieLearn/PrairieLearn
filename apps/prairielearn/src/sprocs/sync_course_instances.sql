...
BEGIN
    ...
    SET
        ...
        enrollment_lti_enforced_after = (src.data->>'enrollment_lti_enforced_after')::timestamp with time zone,
        json_comment = (src.data->>'comment')::jsonb,
        self_enrollment_enabled_before = (src.data->>'self_enrollment_enabled_before')::timestamp with time zone,
