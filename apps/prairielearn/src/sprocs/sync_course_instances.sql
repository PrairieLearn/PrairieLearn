...
BEGIN
    ...
    SET
        ...
        access_control_published = (src.data->>'access_control_published')::boolean,
        access_control_published_start_date_enabled = (src.data->>'access_control_published_start_date_enabled')::boolean,
