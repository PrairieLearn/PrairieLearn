...
BEGIN
    ...
    SET
        ...
        json_comment = (src.data->>'comment')::text,
        ...
        json_external_grading_comment = (src.data->>'external_grading_comment')::text,
        ...
        json_workspace_comment = (src.data->>'workspace_comment')::text,
        sync_errors = NULL,
