...
BEGIN
    ...
    SET
        ...
        shared_publicly_with_source = (src.data->>'shared_source_publicly')::boolean, -- TODO: remove once we are reading from the new column shared_source_publicly instead
