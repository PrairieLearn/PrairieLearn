...
// fields are values computed for the table that don't belong to a single table.
...
export interface AssessmentInstanceTimeFields {
...
export type AssessmentInstanceActionRow = AssessmentInstanceTimeFields & {
