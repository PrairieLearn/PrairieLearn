          ...
          <div class="card mb-4">
            ...
            >
              <thead>
                <tr>
                  <th
                    data-field="assessment_instance_id"
                    data-sortable="true"
                  ...
                  >
                    <span class="sr-only">Assessment instance</span>
                  </th>
                  ${resLocals.assessment.group_work
                    ? html`
                        <th
                        ...
                        <th
                          data-field="group_roles"
                          data-sortable="true"
                          data-class="text-center align-middle text-nowrap"
                          data-formatter="uniqueListFormatter"
                          data-switchable="true"
                        >
                          Roles
                          <button
                  ...
                  ${!resLocals.assessment.group_work
                    ? html`
                        <th
                          data-field="client_fingerprint_id_change_count"
                          data-sortable="true"
                          data-class="text-center align-middle"
                          data-switchable="true"
                        >
