...
export function EditTotalPointsForm({resLocals, id}: {resLocals: Record<string, any>, id: string}) {
    return html`
        <form name="edit-total-points-form" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="points" value="${resLocals.assessment_instance.points}">
