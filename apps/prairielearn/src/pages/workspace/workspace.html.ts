              ...
              <li class="nav-item ml-2 ml-md-3 my-1">
                <a
                  ...
                  data-content='<ul class="list-group list-group-flush">
                              ...
                              <li class="list-group-item p-2"><div class="row"><div class="col col-3 font-weight-bold d-flex align-items-center">What to Tell Students</div> <div class="col col-9"><ul><li> How to save/submit </li> <li> Advise on workspace-specific instructions, e.g. How to interupt/restart the kernel in Jupyter workspaces </li> <li> Set expectations about workspace start times (in the worst case, a workspace may take several minutes as new machines are started and as images are pulled </li> </ul> 
                            </ul>'
                >
