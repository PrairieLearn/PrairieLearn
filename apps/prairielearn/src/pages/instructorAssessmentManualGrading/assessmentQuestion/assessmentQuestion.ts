...
import { benchmarkRubricTuning, clearRubricOptionalFields, deleteAiGradingJobs, generateRubricTuningPrompt, selectInstanceQuestionsForAssessmentQuestion } from '../../../ee/lib/ai-grading/ai-grading-util.js';
import { aiGrade } from '../../../ee/lib/ai-grading/ai-grading.js';
import { config } from '../../../lib/config.js';
import type { Assessment, AssessmentQuestion, Course, CourseInstance, InstanceQuestion, Question } from '../../../lib/db-types.js';
  ...
  asyncHandler(async (req, res) => {
    ...
    if (req.body.__action === 'batch_action') {
      ...
      const {
        ...
        assessment_question: res.locals.assessment_question as AssessmentQuestion,
        course: res.locals.course as Course,
        course_instance: res.locals.course_instance as CourseInstance,
        question: res.locals.question as Question,
        urlPrefix: res.locals.urlPrefix,
        authn_user_id: res.locals.authn_user.user_id,
        openai,
      });
