...
export function AiGradingUnavailableModal({ show, onHide }: { show: boolean; onHide: () => void }) {
  return (
    <Modal show={show} backdrop="static" keyboard={false} onHide={onHide}>
      <Modal.Header closeButton>
        <Modal.Title>AI grading not available</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <p>
            AI grading is specifically for questions that use manual grading. Currently, this question is exclusively
            auto-graded (<code>max_manual_points</code> is 0).
        </p>
        <p className="mb-0">
