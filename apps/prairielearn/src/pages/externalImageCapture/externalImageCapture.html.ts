...
export function ExternalImageCapture({ resLocals }: { resLocals: Record<string, any> }) {
    return PageLayout({
        ...
        preContent: html`
            ${compiledScriptTag('externalImageCaptureClient.ts')}
        `,
        content: html`        
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <p class="text-muted mt-3">
                    Before submitting, ensure that the entire submission is visible, legible, and well-lit in the photo.
                </p>
...
export function ExternalImageCaptureSuccess({
    resLocals
}: {
    ...
    return PageLayout({
        ...
        content: html`
            ...
            <p>Click "Refresh" under the submitted file list in the assessment to update your submission.</p>
        `
    });
}