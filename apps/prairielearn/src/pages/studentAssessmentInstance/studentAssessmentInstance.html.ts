...
<html lang="en">
  ...
  <body>
    ...
    ${renderEjs(import.meta.url, "<%- include('../partials/navbar'); %>", { ...resLocals, navPage: 'assessment_instance' })}
    <main id="content" class="container">
      <div class="card mb-4">
        <div class="card-header bg-primary text-white">
          ${resLocals.assessment_set.abbreviation}${resLocals.assessment.number}: ${resLocals.assessment.title}
                  ...
                  <div class="col-md-9 col-sm-12">
                    ${resLocals.assessment_instance.open && resLocals.authz_result.active
                      ? html`
                        ...
                        `
                      : html`Assessment is <strong>closed</strong> and you cannot answer questions.`}
                  </div>
                `
              : html`
            ...
            (instance_question) => html`
              ${instance_question.start_new_zone && instance_question.zone_title
                ? html`
                  ...
                  `
                : ''}
              <tr class="${instance_question.sequence_locked ? 'bg-light pl-sequence-locked' : ''}">
                <td>
                  ${renderEjs(
                    import.meta.url,
                        ...
                        ? html`
                            ...
                            <td class="text-center">
                              ${renderEjs(
                                ...
                                {
                                  open:
                                    resLocals.assessment_instance.open && instance_question.open,
                                  currentWeight:
                ...
                ${resLocals.assessment.allow_real_time_grading
                  ? html`
                      ...
                      <ul class="my-1">
                        ${resLocals.suspendedSavedAnswers > 1
                          ? html`
                              <li>
                                ...
                                cannot be graded yet because their grade rate has not been reached.
                        ...
                        <li>
                          Look at <strong>Best submission</strong> to confirm that each question has
                          been graded. Questions with <strong>Available points</strong> can be
                  ...
                  : html`
                      <ul class="my-1">
                        <li>
                          Submit your answer to each question with the <strong>Save</strong> button
      ...
      ${renderEjs(import.meta.url, "<%- include('../partials/instructorInfoPanel') %>", resLocals)}
    </main>
  </body>
</html>
