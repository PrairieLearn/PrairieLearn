...
export function RequestCourse({
  ...
  return (
    <>
      ...
      <Modal id="fill-course-request-lti13-modal" show={show} onHide={onHide}>
        ...
        <Modal.Footer>
          <button type="button" className="btn btn-success" onClick={onFill}>
            Fill from LMS data
          </button>
...
function CourseNewRequestCard({ csrfToken }: { csrfToken: string }) {
  return (
    <div className="card mb-4">
      <div className="card-header bg-primary text-white d-flex align-items-center">
