        ...
        <main id="content" class="container">
          ...
          <div class="card mb-4">
            ...
            <form class="question-form" name="course-request" method="POST">
              <div class="card-body">
                <p>
                  This form is for instructors who want to create a new course on PrairieLearn.
                  Students should <strong>not</strong> submit this form and should instead use the
                  "Enroll course" button on the PrairieLearn homepage. Teaching assistants and
                ...
                <div class="form-group">
                  ...
                  <small class="form-text text-muted">
                    Providing your GitHub username will allow you to edit course content offline.
                    You do not need to provide this if you would like to use the online web editor.
                  </small>
                </div>
                <div class="form-group">
                  ...
                  >
                    <p class="card-body">
                      <b>A new course instance must be requested by the instructor.</b> Please ask
                      the official course instructor to submit this form.
                    </p>
                  </div>
                  <div
                    style="display: none;"
                    class="role-comment role-comment-student form-text card"
                  >
                    <p class="card-body">
