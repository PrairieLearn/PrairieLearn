...
<html lang="en">
  ...
  <body>
    ...
    ${renderEjs(__filename, "<%- include('../partials/navbar') %>", { navPage: 'admin', navSubPage: 'courses' })}
      ...
      <div id="courses" class="card mb-4">
        <div class="card-header bg-primary text-white d-flex align-items-center">
          ...
          <button type="button" class="btn btn-sm btn-light ml-auto"
             ...
             data-content="${escapeHtml(renderEjs(__filename, "<%= include('courseInsertForm') %>", { id: 'courseInsertButton' }))}
