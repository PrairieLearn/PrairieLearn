...
import { CourseRequestSchema, DateFromISOString, IdSchema, InstitutionSchema, CourseSchema } from '../../lib/db-types';
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    const result = await sqldb.queryRow(sql.select, [], z.object({
      institutions: z.array(InstitutionSchema),
      courses: z.array(CourseSchema.extend({
