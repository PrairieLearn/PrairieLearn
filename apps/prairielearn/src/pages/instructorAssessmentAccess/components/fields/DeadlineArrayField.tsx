...
export function DeadlineArrayField({
  ...
  const {
    ...
    control,
    name: `${namePrefix}.${fieldPath}.value` as any,
  });
  ...
  const validateCredit = (value: number) => {
    ...
    if (isEarly) {
      ...
      if (value < 0 || value > 99) return 'Must be 0-99%';
    }
    return true;
  };
            ...
            <Row class="mb-1">
              <Col md={6}>
                <Form.Control
                  ...
                  {...control.register(`${namePrefix}.${fieldPath}.value.${index}.date` as any, {
              ...
              <Col md={4}>
                <InputGroup>
                  <Form.Control
                    ...
                    max={isEarly ? '200' : '99'}
                    {...control.register(
                      `${namePrefix}.${fieldPath}.value.${index}.credit` as any,
