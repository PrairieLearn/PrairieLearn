...
import { queryOptionalRow, queryRow, queryRows } from '@prairielearn/postgres';
...
describe('Student groups page', () => {
  ...
  const studentGroupsUrl = `${siteUrl}/pl/course_instance/1/instructor/instance_admin/student_groups`;
