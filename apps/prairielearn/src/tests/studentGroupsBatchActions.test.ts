...
import { execute, queryOptionalRow, queryRow, queryRows } from '@prairielearn/postgres';

import { dangerousFullSystemAuthz } from '../lib/authz-data-lib.js';
import { EnrollmentSchema, StudentGroupSchema } from '../lib/db-types.js';
...
describe('Student groups batch actions', () => {
  ...
  afterAll(async () => {
    ...
    await execute(
      ...
      [enrollment1Id, enrollment2Id, enrollment3Id],
    );
  ...
  test.sequential('should not allow adding to a group from a different course instance', async () => {
