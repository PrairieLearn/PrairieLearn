...
describe('Test workspace dynamic files', function () {
  ...
  it('create workspace question variant', async function () {
    const questionId = await sqldb.queryRow(sql.get_test_question, IdSchema);
    const workspaceQuestionUrl =
