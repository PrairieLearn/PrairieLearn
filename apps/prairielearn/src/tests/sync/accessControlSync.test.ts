...
import { selectAccessControlRulesForAssessment } from '../../lib/assessment-access-control/access-control-data.js';
import { resolveAccessControl } from '../../lib/assessment-access-control/access-control-resolver.js';
import {
