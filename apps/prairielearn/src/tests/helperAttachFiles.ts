...
import { type File, FileSchema } from '../lib/db-types.js';

const sql = sqldb.loadSqlEquiv(import.meta.url);

let elemList: cheerio.Cheerio<Element>;

export interface AttachFileLocals {
  $: cheerio.CheerioAPI;
...
export function attachFile(locals: AttachFileLocals, textFile: boolean) {
...
export function downloadAttachedFile(locals: DownloadAttachedFileLocals) {
...
export function checkNoAttachedFiles(locals: { $: cheerio.CheerioAPI; attachFilesUrl: string }) {
