...
describe(
  'Course with assessments grouped by Set vs Module',
  ...
  function () {
    ...
    test('should default to grouping by Set', async function () {
    ...
    test('should use correct order when grouping by Set', async function () {
    ...
    test('should use correct order when grouping by Module', async function () {
