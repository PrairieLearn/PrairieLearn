...
describe(
  'Generate chunks and use them for a student homework',
  ...
  function () {
    ...
    test('generate course chunks', async () => {
      const course_ids = ['1'];
    ...
    test('visit the "Add two numbers" question', async () => {
