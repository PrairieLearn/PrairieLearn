...
describe(
  ...
  function () {
    ...
    test('try to access the exam when no access rule applies', { concurrent: false }, async () => {
      headers.cookie = 'pl_test_date=1910-06-01T00:00:01Z';
    ...
    test('try to access the exam when it is not active', { concurrent: false }, async () => {
      headers.cookie = 'pl_test_date=2000-06-01T00:00:01Z';
    ...
    test('check that an assessment instance was not created', { concurrent: false }, async () => {
    ...
    test('visit start exam page when the exam is active', { concurrent: false }, async () => {
      headers.cookie = 'pl_test_date=2010-01-01T23:50:01Z';
    ...
    test('start the exam and access questions', { concurrent: false }, async () => {
      const response = await helperClient.fetchCheerio(context.examUrl, {
        method: 'POST',
    ...
    test('count number of variants generated', { concurrent: false }, async () => {
    ...
    test('check that the assessment instance is closed', { concurrent: false }, async () => {
      const results = await sqldb.queryRows(
        sql.select_assessment_instances,
        AssessmentInstanceSchema,
      );
    ...
    test(
      'access question with existing variant when exam is closed',
      { concurrent: false },
      async () => {
    ...
    test(
      'access question without existing variant when exam is closed',
      { concurrent: false },
      async () => {
    ...
    test('access the exam when it is no longer active', { concurrent: false }, async () => {
    ...
    test(
      'access question with existing variant when exam is not active',
      { concurrent: false },
      async () => {
        const response = await helperClient.fetchCheerio(context.examQuestionUrl, {
          headers,
    ...
    test('access clientFilesCourse when exam is not active', { concurrent: false }, async () => {
    ...
    test(
      'access clientFilesCourseInstance when exam is not active',
      { concurrent: false },
      async () => {
    ...
    test(
      'access clientFilesAssessment when exam is not active',
      { concurrent: false },
      async () => {
    ...
    test('ensure that no new variants have been created', { concurrent: false }, async () => {
    ...
    test(
      'access the exam when active and showClosedAssessment are false',
      { concurrent: false },
      async () => {
    ...
    test('try to access the homework when it is not active', { concurrent: false }, async () => {
      headers.cookie = 'pl_test_date=2000-06-01T00:00:01Z';
    ...
    test('access the homework when it is active', { concurrent: false }, async () => {
      headers.cookie = 'pl_test_date=2020-06-01T00:00:01Z';
    ...
    test('access a question when homework is active', { concurrent: false }, async () => {
      headers.cookie = 'pl_test_date=2020-06-01T00:00:01Z';
    ...
    test('access the homework when it is no longer active', { concurrent: false }, async () => {
    ...
    test(
      'access the homework during the late 75% credit window',
      { concurrent: false },
      async () => {
    ...
    test('submit an answer to a question when active is false', { concurrent: false }, async () => {
      headers.cookie = 'pl_test_date=2041-06-01T00:00:01Z';
    ...
    test(
      'try to attach a file to a question when active is false',
      { concurrent: false },
      async () => {
        headers.cookie = 'pl_test_date=2041-06-01T00:00:01Z';
    ...
    test(
      'get CSRF token for attaching file on assessment instance page',
      { concurrent: false },
      async () => {
        headers.cookie = 'pl_test_date=2020-06-01T00:00:01Z';
    ...
    test(
      'try to attach a file to the assessment when active is false',
      { concurrent: false },
      async () => {
        headers.cookie = 'pl_test_date=2041-06-01T00:00:01Z';
    ...
    test(
      'try to attach text to a question when active is false',
      { concurrent: false },
      async () => {
        headers.cookie = 'pl_test_date=2041-06-01T00:00:01Z';
    ...
    test(
      'get CSRF token for attaching text on assessment instance page',
      { concurrent: false },
      async () => {
        headers.cookie = 'pl_test_date=2020-06-01T00:00:01Z';
    ...
    test(
      'try to attach text to the assessment when active is false',
      { concurrent: false },
      async () => {
        headers.cookie = 'pl_test_date=2041-06-01T00:00:01Z';
    ...
    test('check that no files or text were attached', { concurrent: false }, async () => {
