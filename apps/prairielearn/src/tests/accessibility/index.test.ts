...
const SKIP_ROUTES = [
  ...
  '/pl/course_instance/:course_instance_id/variant/:variant_id/cacheableElements/:cachebuster/*',
  ...
  '/pl/course_instance/:course_instance_id/variant/:variant_id/elements/*',
  ...
  '/pl/course_instance/:course_instance_id/variant/:variant_id/instructor/cacheableElements/:cachebuster/*',
  ...
  '/pl/course_instance/:course_instance_id/variant/:variant_id/instructor/elements/*',
  ...
  '/pl/course/:course_id/variant/:variant_id/cacheableElements/:cachebuster/*',
  ...
  '/pl/course/:course_id/variant/:variant_id/elements/*',
