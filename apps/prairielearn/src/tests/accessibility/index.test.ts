...
const SKIP_ROUTES = [
  ...
  '/pl/course/:course_id/question/:question_id/externalImageCapture/variants/:variant_id/answer/:answer_name',
  '/pl/course/:course_id/question/:question_id/externalImageCapture/variants/:variant_idanswer/:answer_name/uploaded_image',
  '/pl/course_instance/:course_instance_id/instance_question/:instance_question_id/externalImageCapture/variant/:variant_id//answer/:answer_name',
  '/pl/course_instance/:course_instance_id/instance_question/:instance_question_id/externalImageCapture/variant/:variant_id//answer/:answer_name/uploaded_image',
