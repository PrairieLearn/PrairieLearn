...
import { generateSubmissionsMath220 } from './ee/lib/ai-image-grading/generate-submissions-math220.js';
...
export async function initExpress(): Promise<Express> {
  ...
  app.get(
    '/pl/generate-submissions-math220',
    async (req, res) => {
      await generateSubmissionsMath220(req, res);
