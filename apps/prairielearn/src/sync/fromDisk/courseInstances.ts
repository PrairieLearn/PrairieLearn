...
function getParamsForCourseInstance(courseInstance: CourseInstanceJson | null | undefined) {
  ...
  return {
    ...
    access_control_publish_date: courseInstance.accessControl?.publishedStartDate ?? null,
    access_control_archive_date: courseInstance.accessControl?.publishedEndDate ?? null,
