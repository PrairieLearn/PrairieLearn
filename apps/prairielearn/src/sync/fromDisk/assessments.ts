...
function getParamsForAssessment(
  ...
  return {
    ...
    team_max_size: groups.maxMembers ?? null,
    team_min_size: groups.minMembers ?? null,
    student_team_create: groups.studentPermissions.canCreateGroup,
    student_team_choose_name: groups.studentPermissions.canNameGroup,
    student_team_join: groups.studentPermissions.canJoinGroup,
    student_team_leave: groups.studentPermissions.canLeaveGroup,
