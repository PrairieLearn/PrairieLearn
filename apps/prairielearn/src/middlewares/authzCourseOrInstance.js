      ...
      async.series(
        [
          async () => {
            ...
            if (!res.locals.authz_data.authn_has_student_access) return;

            // Verify non-enrollment
            if (res.locals.authz_data.authn_has_student_access_with_enrollment) return;
          ...
          async () => {
            ...
            if (!req.cookies.pl_requested_uid) return;
            ...
            const result = await sqldb.queryZeroOrOneRowAsync(sql.select_user, params);
          ...
          async () => {
            ...
            if (
              ...
              err.info = html`
                <p>
                  You have tried to change the effective user to one who is a course previewer, when
                  you are not a course previewer. All requested changes to the effective user have
                  been removed.
                </p>
              `.toString();
              throw err;
            ...
            if (
              ...
              err.info = html`
                <p>
                  ...
                  you are not a course viewer. All requested changes to the effective user have been
                  removed.
                </p>
              `.toString();
              throw err;
            ...
            if (
              ...
              err.info = html`
                <p>
                  ...
                  you are not a course editor. All requested changes to the effective user have been
                  removed.
                </p>
              `.toString();
              throw err;
            ...
            if (
              ...
              err.info = html`
                <p>
                  You have tried to change the effective user to one who is a course owner, when you
                  are not a course owner. All requested changes to the effective user have been
                  removed.
                </p>
              `.toString();
              throw err;
            ...
            if (isCourseInstance) {
              ...
              if (
                ...
                err.info = html`
                  <p>
                    You have tried to change the effective user to one who can view student data in
                    the course instance <code>${res.locals.course_instance.short_name}</code>, when
                    you do not have permission to view these student data. All requested changes to
                    the effective user have been removed.
                  </p>
                `.toString();
                throw err;
              }
              ...
              if (
                ...
                err.info = html`
                  <p>
                    You have tried to change the effective user to one who can edit student data in
                    the course instance <code>${res.locals.course_instance.short_name}</code>, when
                    you do not have permission to edit these student data. All requested changes to
                    the effective user have been removed.
                  </p>
                `.toString();
                throw err;
              ...
              if (
                ...
                err.info = html`
                  <p>
                    ...
                    course instance <code>${res.locals.course_instance.short_name}</code>, when you
                    do not have permission to edit student data in this course instance. All
                    requested changes to the effective user have been removed.
                  </p>
                `.toString();
                throw err;
