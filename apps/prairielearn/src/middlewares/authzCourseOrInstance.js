    ...
    async () => {
      ...
      if (isCourseInstance) {
        ...
        if (
          ...
          err.info = html`
            <p>
              You have tried to change the effective user to one who can view student data in the
              course instance <code>${res.locals.course_instance.short_name}</code>, when you do not
              have permission to view these student data. All requested changes to the effective
              user have been removed.
            </p>
          `.toString();
          throw err;
        ...
        if (
          ...
          err.info = html`
            <p>
              You have tried to change the effective user to one who can edit student data in the
              course instance <code>${res.locals.course_instance.short_name}</code>, when you do not
              have permission to edit these student data. All requested changes to the effective
              user have been removed.
            </p>
          `.toString();
          throw err;
      ...
      res.locals.authz_data.courses.forEach(
        (course) => (course.permissions_course = _.cloneDeep(result.rows[0].permissions_course)),
      );
