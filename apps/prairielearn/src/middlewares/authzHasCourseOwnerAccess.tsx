...
export default function (req: Request, res: Response, next: NextFunction) {
  const effectiveAccess = res.locals.authz_data.has_course_permission_own;

  const authenticatedAccess = res.locals.authz_data.authn_has_course_permission_own;
  ...
  if (effectiveAccess) {
    ...
    return next(new HttpStatusError(403, 'Access denied (must be course owner)'));
  }
}
