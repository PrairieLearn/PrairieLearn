...
export function AccessRulesTable({
  ...
  return html`
      <div class="table-responsive js-access-rules-table" id="table-responsive" data-pt-host="${ptHost}" data-dev-mode="${devMode}" data-has-course-instance-permission-view="${hasCourseInstancePermissionView}" data-timezone>
                ...
                return html`
                  <tr class="tableDataRow">
                    <td class="arrowButtonsCell align-content-center" ${editMode ? '' : 'hidden'}>
                      <div>
                        <button class="btn btn-xs btn-secondary up-arrow-button" data-row="${i}">
                          <i class="fa fa-arrow-up" aria-hidden="true"></i>
                        </button>
                      </div>
                      <div>
                        <button class="btn btn-xs btn-secondary down-arrow-button" data-row="${i}">
                    ...
                    <td class="align-content-center">${access_rule.mode}</td>
                    ...
                    <td class="align-content-center">${access_rule.time_limit}</td>
                    <td class="align-content-center">${access_rule.password}</td>
                    <td class="align-content-center">
