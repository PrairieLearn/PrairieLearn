  ...
  if (req.method !== 'OPTIONS') {
    res.on('finish', function () {
      var access = {
        ...
        body: req.body,
        authn_user_id:
          res.locals && res.locals.authn_user
        ...
        course_id:
          res.locals && res.locals.course ? res.locals.course.id : null,
        course_short_name:
          res.locals && res.locals.course ? res.locals.course.short_name : null,
        course_instance_id:
          res.locals && res.locals.course_instance
        ...
        course_instance_short_name:
          res.locals && res.locals.course_instance
            ...
            : null,
        assessment_id:
          res.locals && res.locals.assessment ? res.locals.assessment.id : null,
        assessment_directory:
          res.locals && res.locals.assessment
            ? res.locals.assessment.tid
            : null,
        assessment_instance_id:
          res.locals && res.locals.assessment_instance
            ? res.locals.assessment_instance.id
            : null,
        question_id:
          res.locals && res.locals.question ? res.locals.question.id : null,
        question_directory:
          res.locals && res.locals.question
            ? res.locals.question.directory
            : null,
        instance_question_id:
          res.locals && res.locals.instance_question
