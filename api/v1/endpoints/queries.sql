...
WITH object_data AS (
    SELECT
        ...
        aq.manual_points AS assessment_question_manual_points,
        ...
        iq.auto_score_perc AS instance_question_auto_score_perc,
        iq.manual_score_perc AS instance_question_manual_score_perc,
