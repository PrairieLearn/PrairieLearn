...
def render(element_html, element_index, data):
    ...
    for child in element:
        ...
        if child.tag == 'variable':
            ...
            pl.check_attribs(child, required_attribs=['params-name'], optional_attribs=['digits', 'presentation-type'])
            ...
            presentation_type = pl.get_string_attrib(child, 'presentation-type', 'f')
