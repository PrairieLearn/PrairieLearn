...
def prepare(element_html, element_index, data):
    ...
    optional_attribs = ['weight', 'label', 'comparison', 'rtol', 'atol', 'digits', 'format_type', 'allow_partial_credit', 'allow_feedback']
...
def grade(element_html, element_index, data):
    element = lxml.html.fragment_fromstring(element_html)
    name = pl.get_string_attrib(element, 'answers_name')
    allow_partial_credit = pl.get_string_attrib(element, 'allow_partial_credit', False)
