...
window.PLFileEditor = function (uuid, options) {
  ...
  window.PLFileEditor.prototype.initSettingsButton = function (uuid) {
    ...
    this.settingsButton.click(function () {
      var textsizeShow = that.element.find(".textsize-current");
      textsizeShow.text(parseInt(that.editor.getFontSize()));
      ...
      sessionStorage.setItem('pl-file-editor-textsize-current', parseInt(that.editor.getFontSize()));
    ...
    this.saveSettingsButton.click(function () {
      ...
      localStorage.setItem('pl-file-editor-textsize', textsize);
    ...
    this.closeSettingsButton.click(function () {
      ...
      that.editor.setFontSize(sessionStorage.getItem('pl-file-editor-textsize-current'));
      sessionStorage.removeItem('pl-file-editor-theme-current');
      sessionStorage.removeItem('pl-file-editor-textsize-current');
    });
  };
