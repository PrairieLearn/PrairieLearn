...
def render(element_html: str, data: pl.QuestionData) -> str:
    ...
    for child in element:
        if child.tag == 'pl-variable':
            ...
            raise ValueError(f"Tags inside of pl-external-grader-variables must be pl-variable, not '{child.tag}'.")
    ...
    has_descriptions = any('description' in var_description for var_description in names_user_description)
