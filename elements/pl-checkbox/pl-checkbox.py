...
def render(element_html, data):
    ...
    display_answers = data['params'].get(name, {'display_answers': []})['display_answers']
    ...
    if data['panel'] == 'question':
        ...
        if not hide_help_text:
            ...
            min_correct = data['params'][name]['min_correct']
            max_correct = data['params'][name]['max_correct']
...
def parse(element_html, data):
    ...
    all_keys = [a['key'] for a in data['params'][name]['display_answers']]
...
def grade(element_html, data):
    ...
    partial_credit = pl.get_boolean_attrib(element, 'partial-credit', PARTIAL_CREDIT_DEFAULT)
    number_answers = len(data['params'][name]['display_answers'])
    partial_credit_method = pl.get_string_attrib(element, 'partial-credit-method', PARTIAL_CREDIT_METHOD_DEFAULT)
