...
The user directory is initially empty. Any files and directories that are required for testing must be either be created by the JUnit test class itself, or provided in the question's `tests/studentFiles` directory.
