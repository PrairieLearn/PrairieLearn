...
* To prevent students from seeing their total exam score as soon as the exam is over, set `"showClosedAssessmentGrade": false`, otherwise the students will see their total score (even if the per-question score is hidden).
