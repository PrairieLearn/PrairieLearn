...
To provide a simple example, here we first create a question without any randomization, by modifying the file [question.html](question/index.md#question-questionhtml).
...
We will add randomization to the previous question, using the file [server.py](question/index.md#question-serverpy)
