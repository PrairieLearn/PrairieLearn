...
* [questions starting from provided examples](#Creating-questions-from-example-course)
...
* change the course instance name in `"longName"`. For example:
...
![](start-guide/homepage_new_instance.png =800x)
...
![](start-guide/question_tab.png =800x)
...
![](start-guide/question_add_new_1.png =800x)
...
![](start-guide/change-example-course.png =800x)
...
![](start-guide/create_assessment.png =800x)
