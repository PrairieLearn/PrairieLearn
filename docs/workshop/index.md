...
!!! warning "Outdated content"
    ...
    This workshop was last offered in Summer 2020. UI screenshots, element options, and recommended workflows have changed since then. Use it for conceptual orientation, but cross-check specifics against the current docs (start with [Get started](../getting-started/index.md)).
...
3. **Complete the ["Get Started" tutorial](../getting-started/index.md)**, which will show you how to create course instances, assessments, and questions.
