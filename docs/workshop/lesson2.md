...
There are many options to customize when and who should have access to your assessment. Take a look at the legacy [Access Control](../assessment/accessControlLegacy.md) docs to learn more. Here I will briefly describe the option `mode`
