...
When using [PrairieTest](https://us.prairietest.com/pt/docs/center/setup-center) to schedule and deliver PrairieLearn exams, you need to using the following configuration:
