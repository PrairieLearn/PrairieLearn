...
`pl-matrix-component-input` [documentation](https://prairielearn.readthedocs.io/en/latest/elements/pl-matrix-component-input) and [example](https://us.prairielearn.com/pl/course/108/question/1793641/preview)

`pl-matrix-input` [documentation](https://prairielearn.readthedocs.io/en/latest/elements/pl-matrix-input) and [example](https://us.prairielearn.com/pl/course/108/question/611932/preview)

`pl-matrix-latex` [documentation](https://prairielearn.readthedocs.io/en/latest/elements/pl-matrix-latex) and [example](https://us.prairielearn.com/pl/course/108/question/1793638/preview)
...
`pl-overlay` [documentation](https://prairielearn.readthedocs.io/en/latest/elements/pl-overlay) and [example](https://us.prairielearn.com/pl/course/108/question/7911589/preview)
