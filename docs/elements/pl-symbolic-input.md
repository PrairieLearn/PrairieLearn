...
| `allow-set-notation`            | boolean                 | false                   | Whether set and interval notation are allowed. [See below for more details](#set-notation).                                                                                                                                                                                                                                                     |
...
If `allow-set-notation="true"`, the following additional layer of syntax is enabled:
