...
| `graph-width`    | integer           | 800      | Display width of the canvas in pixels. Note that the element is not responsive, so larger widths can cause display issues and should be used with care.                                                   |
| `graph-height`   | integer           | 450      | Screen height of the canvas in pixels.                                                                                                                                                                    |
...
| `allow-blank`    | boolean           | false    | Allows the graph to be graded even if it is unchanged compared to its initial state.                                                                                                                      |
