...
| `limit-size`                  | integer                                               | 7 or 10        | Positive character width of each indexing field. The default is 7 for bounds indexing and 10 for domain or approaches indexing.                                                                     |
