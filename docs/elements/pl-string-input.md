...
| `display`                 | `"block"`, `"inline"`, or `"embed"`   | `"inline"`      | How to display the input field. Default is `"block"` if `multiline` is enabled. Cannot be set to `"inline"` or `"embed"` when `multiline="true"`.                                                     |
...
| `size`                    | integer                               | 35              | Width of the input box. In `display="embed"` mode, this value is interpreted as a width in pixels.                                                                                                    |
