...
| `partial-credit`      | boolean                                                        | true            | Whether to award proportional partial credit for each correctly matched statement. If false, the element awards full credit only when every statement is matched correctly.                                              |
