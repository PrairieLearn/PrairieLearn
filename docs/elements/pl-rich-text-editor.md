...
| `max-word-count`     | integer                             | none                 | Maximum allowed words; exceeding this triggers validation error and prevents submission.                                                                                                                                                                                                                                                                                                                                                                   |
| `min-word-count`     | integer                             | none                 | Minimum required words; falling below this triggers validation error and prevents submission.                                                                                                                                                                                                                                                                                                                                                               |
