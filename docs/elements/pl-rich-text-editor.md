...
| `counter`            | `"word"`, `"character"` or `"none"` | `"none"`             | Whether a word or character count should be displayed at the bottom of the editor. If `min-word-count` or `max-word-count` are set, then `counter` must be `"word"`; setting it explicitly to `"none"` or `"character"` is rejected.                                                                                                                                                                                                                      |
