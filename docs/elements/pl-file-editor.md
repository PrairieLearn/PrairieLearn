...
| `ace-mode`           | string  | —                    | Specifies an Ace editor mode to enable things like intelligent code indenting and syntax highlighting. May be set to [a default Ace mode or an course-defined mode](#extending-the-file-editor-functionality).                                                                                                                                                                                                                                            |
...
| `preview`            | string  | —                    | If set, provides a live preview mode for editing markup languages. Currently, `"html"`, `"markdown"`, or `"dot"` are available, though [additional languages are supported via extensions](#extending-the-file-editor-functionality).                                                                                                                                                                                                                     |
