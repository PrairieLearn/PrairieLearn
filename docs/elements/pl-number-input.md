...
| `correct-answer`      | float or `""`                         | See description | Correct answer for grading. Defaults to `data["correct_answers"][answers-name]`. A blank correct answer (`correct-answer=""`) is only valid when `allow-blank="true"` and `blank-value=""`.                                                                                                                                                                                                                                                                                                       |
...
| `display`             | `"block"`, `"inline"`, or `"embed"`   | `"inline"`      | How to display the input field.                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `show-correct-answer` | boolean                               | true            | Controls whether the correct reference answer is shown in the answer panel.                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `show-help-text`      | boolean                               | true            | Show the question mark at the end of the input displaying required input parameters.                                                                                                                                                                                                                                                                                                                                                                                                              |
| `show-placeholder`    | boolean                               | true            | Whether to show the generated placeholder text when `placeholder` is not set.                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `show-score`          | boolean                               | true            | Whether to show the score badge next to this element.                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `size`                | integer                               | 35              | Size of the input box. In `display="embed"` mode, this value is interpreted as a width in pixels.                                                                                                                                                                                                                                                                                                                                                                                                 |
| `suffix`              | string                                | —               | A suffix to display after the input box (e.g., `suffix="$\rm m/s^2$"`).                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `weight`              | integer                               | 1               | Weight to use when computing a weighted average score over elements.                                                                                                                                                                                                                                                                                                                                                                                                                              |

## Embed display

Set `display="embed"` when the input must stay tightly aligned with surrounding content, such as an input positioned over an image. Embed uses smaller margins and interprets `size` as a pixel width. For example, `size="48"` renders a textbox that is 48 pixels wide.

In embed mode, grading feedback is shown with compact status styling instead of full score badges so the input does not shift position after submission.
