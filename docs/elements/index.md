...
- [`pl-big-operator-input`](pl-big-operator-input.md): Fill in an indexed big operator such as a sum, product, integral, or limit.
...
| [`pl-big-operator-input`](pl-big-operator-input.md)               | Submission     | Indexed big operator.                         |
