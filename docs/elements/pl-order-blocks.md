...
| `wrap-inline`         | boolean                                                           | false                            | `false` sets the blocks to be in one line with horizontal scrolling, whereas `true` wraps the blocks into multiple lines. Only valid when the `inline` attribute is `true`.                                                                                                                                                                                                                                                                                                  |
