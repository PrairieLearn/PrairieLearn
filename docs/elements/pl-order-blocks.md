...
| Attribute             | Type               | Default | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| --------------------- | ------------------ | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `comment`             | string             | —       | Optional attribute when `grading-method="dag"`. Used to provide an HTML comment attached to the answer block.                                                                                                                                                                                                                                                                                                                                                                |
...
| `indent`              | integer in [-1, 4] | —       | Specifies the correct indentation level of the block. For example, a value of `2` means the block should be indented twice. Set the value to `-1` to indicate that the indentation of the block does not matter. This attribute can only be used when `indentation="true"`.                                                                                                                                                                                                  |
