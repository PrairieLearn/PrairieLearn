...
| `pre-dragged`         | boolean            | false   | Optional attribute only allowed in correct blocks without distractors. When used, the block will initially appear in the dragged zone.                                                                                                                                                                                                                                                                                                                                       |
