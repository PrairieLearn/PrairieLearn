...
- On the shell of your WSL 2 instance, make sure the instance has the Docker Engine installed. The installation process may depend on your distribution. For current instructions, [follow the Docker documentation for the distribution of your WSL 2 instance](https://docs.docker.com/engine/install/).
