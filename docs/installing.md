...
If you want to contribute improvements or features to PrairieLearn, you will need to startup PrairieLearn differently. More information for developers can be found on the [Running in Docker](./installingLocal.md) page.
