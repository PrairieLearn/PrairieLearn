...
A suggested template for a Python script that can be used to update scores is available in the [PrairieLearn GitHub repository](https://github.com/PrairieLearn/PrairieLearn/blob/master/contrib/regrading_sample.py).
