...
- the question is set to [`"singleVariant": true` in the question configuration file](../question/index.md#the-singlevariant-option-for-non-randomized-questions). In this case, students will get unlimited attempts for the same variant.
