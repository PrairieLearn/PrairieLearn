...
- The value "Closed" indicates that the student has already finished the assessment, that their time ran out, or ([for exam assessments with `autoClose` set as `true`](../assessment/configuration.md#auto-closing-exam-assessments)) that the student was inactive for more than 15 minutes. Students do not have the ability to submit answers for these assessments.
