...
![Modern access control page showing Defaults and Overrides](accessControl/01-overview.png)
/// caption
...
![Defaults editor panel for modern access control](accessControl/02-defaults-editor.png)
/// caption
