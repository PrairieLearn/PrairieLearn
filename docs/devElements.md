...
The above table describes the purpose of each function and the keys in `data` that are allowed to be modified. Any changes will be persisted to the database. No function is allowed to add or delete keys in `data`.
