...
| `render()`   | `html` (string) |                                                                                                          | `correct_answers`, `editable`, `manual_grading`, `feedback`, `format_errors`, `options`, `panel`, `params`, `partial_scores`, `raw_submitted_answers`, `score`, `submitted_answers`, `variant_seed`, `extensions`, `num_valid_submissions` | Render the HTML for one panel and return it as a string.                                                                                                                                                                                                                                                                                                                        |
| `parse()`    |                 | `format_errors`, `submitted_answers`, `correct_answers`, `feedback`                                      | `options`, `params`, `raw_submitted_answers`, `variant_seed`, `extensions`                                                                                                                                                                 | Parse the `data["submitted_answers"][var]` data entered by the student, modifying this variable. Return the modified `data` dictionary.                                                                                                                                                                                                                                         |
| `grade()`    |                 | `correct_answers`, `format_errors`, `params`, `partial_scores`, `score`, `submitted_answers`, `feedback` | `options`, `raw_submitted_answers`, `variant_seed`, `extensions`                                                                                                                                                                           | Grade `data["submitted_answers"][var]` to determine a score. Store the score and any feedback in `data["partial_scores"][var]["score"]` and `data["partial_scores"][var]["feedback"]`. Return the modified `data` dictionary.                                                                                                                                                   |
