...
| `parse()`    | `None`        | `params`, `correct_answers`, `feedback`, `format_errors`, `submitted_answers`                            | `extensions`, `options`, `raw_submitted_answers`, `variant_seed`                                                                                                                                                                            | Parse the `data["submitted_answers"][var]` data entered by the student, modifying this variable.                                                                                                                                                                                                                                                                                 |
