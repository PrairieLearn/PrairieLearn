...
| `data["options"]`               | dict    | Any options associated with the question, such as to [access client files](./clientServerFiles.md#accessing-files-from-serverpy-question-code).                              |
