...
| `grade()`    |                 | `correct_answers`, `format_errors`, `partial_scores`, `score`, `submitted_answers` | `params`, `options`, `raw_submitted_answers`, `variant_seed`, `extensions`                                                                                                                                                                 | Grade `data["submitted_answers"][var]` to determine a score. Store the score and any feedback in `data["partial_scores"][var]["score"]` and `data["partial_scores"][var]["feedback"]`. Return the modified `data` dictionary.                                                                                                                                                   |
