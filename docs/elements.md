...
| `final`\*             | boolean            | —       | Required on exactly one `pl-answer` tag when `grading-method="dag"` and a `\|` is used to denote optional blocks.                                                                                                                                                                                                                                                                                                                                                     |
...
> **_NOTE:_**
>
> - When using optional lines, the question must contain one block that serves as the final block in every ordering. The `pl-answer` tag that declares this block must have the attribute `final` set to `true`.
