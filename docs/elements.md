...
| `additional-simplifications`    | string                  | -                       | Simplifications that should be applied during grading before using SymPy's built-in equality checker. Using this attribute can prevent rare cases of non-convergence during grading. See [the documentation on this issue](nonConvergence.md) for more details before using this attribute.                                                     |
