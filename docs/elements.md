...
| `format`             | string  | `html` or `markdown`          | Format used to save the student's response. This format also affects how the source file name or inner HTML is interpreted.                                                                                                                                                                                                                                                                                                                           |
...
| `counter`            | string  | `word`, `character` or `none` | Display a `word` or `character` count.                                                                                                                                                                                                                                                                                                                                                                                                                |
