...
| `aria-label`                    | string                  | —                       | An accessible label for the element.                                                                                                                                                                                                                                                                                                            |
| `display`                       | `"block"` or `"inline"` | `"inline"`              | How to display the input field.                                                                                                                                                                                                                                                                                                                 |
| `formula-editor`                | boolean                 | true                    | Whether the element should provide a visual formula editor for students (recommended when answers are long or contain nested mathematical expressions).                                                                                                                                                                                         |
| `show-formula-editor-buttons`   | boolean                 | false                   | Whether the formula editor should provide a buttons to access a virtual keyboard and shortcuts for common mathematical operations.                                                                                                                                                                                                              |
