...
| `line-number-color`            | text    | `black`     | Specifies the color for line numbers.                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `line-number-background-color` | text    | `lightgray` | Specifies the background color for line numbers.                                                                                                                                                                                                                                                                                                                                                                                                      |
