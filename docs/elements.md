...
| `normalize-whitespace`  | boolean | false           | Whether to strip leading/trailing whitespace and dedent the contents. Recommended for cases where the code is inline in the question file.                                                                                                                                                                                                                                                                                                                |
