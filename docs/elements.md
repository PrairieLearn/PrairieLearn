...
| `distractor-info`       | "show-distractors" or "show-feedback"                                 | -                              | The level of feedback that is to be given to students with respect to the distractors. `show-distractors` will show students which blocks were incorrect after the problem has been solved or all attempts have been sued. `show-feedback` shows the same but includes the feedback strings associated with each distractors as we by the `distractor-feedback` attribute for each `<pl-answer>` block.                                                                                                                                                                                                                                                                                                          |
...
| `distractor-feedback`     | string             | ""      | Optional attribute, used when `correct=false` that indicates why a given block is incorrect or should not be included in the solution.                                                                                                                                                                                                                                                |
