...
| `preview`            | string  | None               | If set, provides a live preview mode for editing markup languages. Currently supports `html` or `markdown`, though additional languages are supported via extensions (see below).                                                                                                                                                                                                                                                                                                                                   |
...
This element supports additional preview options through [element extensions](elementExtensions.md). A sample implementation of a preview of the Dot language can be found [in the example course](https://github.com/PrairieLearn/PrairieLearn/tree/master/exampleCourse/elementExtensions/pl-file-editor/dot-preview).
