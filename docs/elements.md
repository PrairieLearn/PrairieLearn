...
| `show-formula-editor-buttons`   | boolean                 | true                    | Whether the formula editor should provide a buttons to access a virtual keyboard and shortcuts for common mathematical operations.                                                                                                                                                                                                              |
