...
| `correct-answer`           | string  | special                             | Accepted for validation but not used by the element. The correct answer is defined by the objects placed inside `pl-drawing-answer` (and `pl-drawing-initial`), not by this attribute.                                                              |
