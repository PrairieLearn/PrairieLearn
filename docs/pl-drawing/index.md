...
| `show-score`               | boolean | false                                        | Whether to show the score badge next to this element in the "Question" and "Submitted answer" panels. Defaults to `false` for backwards compatibility.                      |
