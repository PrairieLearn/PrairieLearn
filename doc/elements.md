...
`source-file-name` | string | None | Name of the file with content to be displayed inside the text editor (instead - or in addition to - writing the text between the open/closing tags).
