            ...
            async.series([
                ...
                (callback) => {
                    module.exports.getContext(question, course, (err, context) => {
                        ...
                        dependencies.clientFilesCourseStyles.forEach((file) => styleUrls.push(`${res.locals.urlPrefix}/clientFilesCourse/${file}`));
                        dependencies.clientFilesCourseScripts.forEach((file) => scriptUrls.push(`${res.locals.urlPrefix}/clientFilesCourse/${file}`));
                        ...
                        dependencies.courseElementStyles.forEach((file) => styleUrls.push(`${res.locals.urlPrefix}/elements/${file}`));
                        dependencies.courseElementScripts.forEach((file) => scriptUrls.push(`${res.locals.urlPrefix}/elements/${file}`));
                        const headerHtmls = [
