...
module.exports.run = function(callback) {
    util.callbackify(async () => {
        ...
        const result = await sqldb.queryAsync(sql.select_almost_stale_workspaces, params);
        ...
        for (const workspace of workspaces) {
            ...
            logger.verbose(`warnStaleWorkspaces: timeout warning for workspace_id = ${workspace.id}`);
