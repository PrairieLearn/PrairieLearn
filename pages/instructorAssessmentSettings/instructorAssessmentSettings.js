...
router.get('/', function(req, res, next) {
    ...
    async.series([
        ...
        debug('render page');
        res.locals.studentLink = 'https://' + req.headers.host + res.locals.plainUrlPrefix + '/course_instance/' + res.locals.course_instance.id + '/assessment/' + res.locals.assessment.id;
