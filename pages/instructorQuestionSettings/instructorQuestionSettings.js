...
router.post('/', function(req, res, next) {
    if (req.body.__action == 'test_once') {
        ...
        const assessment_groupwork = res.locals.assessment ? res.locals.assessment.groupwork : false;
        question.startTestQuestion(count, showDetails, res.locals.question, assessment_groupwork, res.locals.course_instance, res.locals.course, res.locals.authn_user.user_id, (err, job_sequence_id) => {
