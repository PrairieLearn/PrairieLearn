...
console.log('');
console.log('curl -H "X-Auth-UID: ' + uid + '" -H "X-Auth-Name: ' + name + '" -H "X-Auth-Date: ' + date + '" -H "X-Auth-Signature: ' + signature + '" <url>');
console.log('');
console.log('Curl command to export and save all user scores:');
console.log('');
console.log('curl -O -H "X-Auth-UID: ' + uid + '" -H "X-Auth-Name: ' + name + '" -H "X-Auth-Date: ' + date + '" -H "X-Auth-Signature: ' + signature + '" <url>/export.csv');
console.log('');
