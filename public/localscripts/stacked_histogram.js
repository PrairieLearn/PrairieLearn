function stacked_histogram(selector, data, data2, bucketNames, options) {
  ...
  var xAxis = d3.axisBottom().scale(x).tickFormat(xTickFormat);
  ...
  svg
    ...
    .attr('x', function (d, i) {
      return x(bucketNames[i]);
    })
    .attr('y', function (d, i) {
      return y(d);
    })
    .attr('width', function (d, i) {
      return x(bucketNames[1]) - x(bucketNames[0]);
    })
