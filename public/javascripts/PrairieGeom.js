...
(function() {
    ...
    */
    PrairieGeom.prototype.ensureArray2D = function(data) {
        if (typeof data === "number") {
            ...
            return _(data.elements).map(function(e) {return [e];});
            ...
            if (typeof data[0] === "number") {
                return _(data).map(function(e) {return [e];});
            }
        }
        return data;
    };
    ...
    */
    PrairieGeom.prototype.hConcatArray2D = function(m1, m2) {
        if (m1 === undefined)
            return m2;
        return _.map(_.zip(m1, m2), function(r) {return r[0].concat(r[1]);});
    };
    ...
    */
    PrairieGeom.prototype.getElemsArray = function(v, indList) {
        return _(indList).map(function(i) {return v[i];});
    };
    ...
    */
    PrairieGeom.prototype.insideBoundingBox = function(lower, upper, point) {
        ...
        var inside = true;
        for (var i = 1; i < n + 1; i++) {
            if (point.e(i) < lower.e(i) || point.e(i) > upper.e(i))
                inside = false;
        }
        return inside;
    };
    ...
    */
    PrairieGeom.prototype.prodPoly = function(poly1, poly2) {
        var p = [], i, j;
        for (i = 0; i < poly1.length + poly2.length - 1; i++)
            p.push(0);
        for (i = 0; i < poly1.length; i++)
            for (j = 0; j < poly2.length; j++)
                p[i + j] += poly1[i] * poly2[j];
        return p;
    };
    ...
    */
    PrairieGeom.prototype.evalFcn = function(fcn, x) {
        /* jshint indent: false */
        switch (fcn.fcn) {
        case "poly": return this.evalPoly(fcn.data, x);
        case "exp": return this.evalExp(fcn.data, x);
        case "trig": return this.evalTrig(fcn.data, x);
        }
    };
    ...
    */
    PrairieGeom.prototype.diffFcn = function(fcn) {
        /* jshint indent: false */
        switch (fcn.fcn) {
        case "poly": return {fcn: "poly", data: this.diffPoly(fcn.data)};
        case "exp": return {fcn: "exp", data: this.diffExp(fcn.data)};
        case "trig": return {fcn: "trig", data: this.diffTrig(fcn.data)};
        }
    };
    ...
    */
    PrairieGeom.prototype.intFcn = function(fcn) {
        /* jshint indent: false */
        switch (fcn.fcn) {
        case "poly": return {fcn: "poly", data: this.intPoly(fcn.data)};
        case "exp": return {fcn: "exp", data: this.intExp(fcn.data)};
        case "trig": return {fcn: "trig", data: this.intTrig(fcn.data)};
        }
    };
    ...
    */
    PrairieGeom.prototype.hammingScore = function(trueVals, submittedVals) {
        var nTrue = 0, nFalse = 0, nWrong = 0;
        for (var i = 0; i < trueVals.length; i++) {
            if (trueVals[i])
                nTrue++;
            else
                nFalse++;
            if (trueVals[i] !== submittedVals[i])
                nWrong++;
        }
    ...
    */
    ...
    window.PrairieGeom = new PrairieGeom();
}());
